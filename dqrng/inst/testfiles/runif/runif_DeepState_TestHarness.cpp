...
TEST(dqrng_deepstate_test,runif_test){
  ...
  qs::c_qsave(min,"/home/akhila/fuzzer_packages/fuzzedpackages/dqrng/inst/testfiles/runif/inputs/min.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "min values: "<< min << std::endl;
  NumericVector max(1);
  max[0]  = RcppDeepState_double();
  qs::c_qsave(max,"/home/akhila/fuzzer_packages/fuzzedpackages/dqrng/inst/testfiles/runif/inputs/max.qs",
		"high", "zstd", 1, 15, true, 1);
