...
TEST(dqrng_deepstate_test,runif_test){
  ...
  std::string min_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dqrng/inst/testfiles/runif/AFL_runif/afl_inputs/" + std::to_string(t) + "_min.qs";
  qs::c_qsave(min,min_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "min values: "<< min << std::endl;
  NumericVector max(1);
  max[0]  = RcppDeepState_double();
  std::string max_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dqrng/inst/testfiles/runif/AFL_runif/afl_inputs/" + std::to_string(t) + "_max.qs";
