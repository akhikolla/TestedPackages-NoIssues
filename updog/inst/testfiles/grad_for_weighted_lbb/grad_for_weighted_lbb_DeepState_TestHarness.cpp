...
TEST(updog_deepstate_test,grad_for_weighted_lbb_test){
  ...
  qs::c_qsave(parvec,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/grad_for_weighted_lbb/inputs/parvec.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "parvec values: "<< parvec << std::endl;
  IntegerVector ploidy(1);
  ploidy[0]  = RcppDeepState_int();
  qs::c_qsave(ploidy,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/grad_for_weighted_lbb/inputs/ploidy.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ploidy values: "<< ploidy << std::endl;
  NumericVector weight_vec  = RcppDeepState_NumericVector();
  qs::c_qsave(weight_vec,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/grad_for_weighted_lbb/inputs/weight_vec.qs",
		"high", "zstd", 1, 15, true, 1);
