...
TEST(updog_deepstate_test,grad_for_weighted_lbb_test){
  ...
  std::string parvec_t = "/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/grad_for_weighted_lbb/libFuzzer_grad_for_weighted_lbb/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_parvec.qs";
  ...
  std::string ploidy_t = "/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/grad_for_weighted_lbb/libFuzzer_grad_for_weighted_lbb/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ploidy.qs";
  qs::c_qsave(ploidy,ploidy_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ploidy values: "<< ploidy << std::endl;
  NumericVector weight_vec  = RcppDeepState_NumericVector();
  std::string weight_vec_t = "/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/grad_for_weighted_lbb/libFuzzer_grad_for_weighted_lbb/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_weight_vec.qs";
