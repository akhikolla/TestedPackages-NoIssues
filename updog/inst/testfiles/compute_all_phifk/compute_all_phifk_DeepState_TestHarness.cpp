...
TEST(updog_deepstate_test,compute_all_phifk_test){
  ...
  qs::c_qsave(alpha,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/compute_all_phifk/inputs/alpha.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "alpha values: "<< alpha << std::endl;
  NumericVector rho  = RcppDeepState_NumericVector();
  qs::c_qsave(rho,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/compute_all_phifk/inputs/rho.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "rho values: "<< rho << std::endl;
  IntegerVector ploidy(1);
  ploidy[0]  = RcppDeepState_int();
  qs::c_qsave(ploidy,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/compute_all_phifk/inputs/ploidy.qs",
		"high", "zstd", 1, 15, true, 1);
