...
TEST(updog_deepstate_test,obj_for_weighted_lnorm_test){
  ...
  std::string parvec_t = "/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/obj_for_weighted_lnorm/AFL_obj_for_weighted_lnorm/afl_inputs/" + std::to_string(t) + "_parvec.qs";
  qs::c_qsave(parvec,parvec_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "parvec values: "<< parvec << std::endl;
  IntegerVector ploidy(1);
  ploidy[0]  = RcppDeepState_int();
  std::string ploidy_t = "/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/obj_for_weighted_lnorm/AFL_obj_for_weighted_lnorm/afl_inputs/" + std::to_string(t) + "_ploidy.qs";
  qs::c_qsave(ploidy,ploidy_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ploidy values: "<< ploidy << std::endl;
  NumericVector weight_vec  = RcppDeepState_NumericVector();
  std::string weight_vec_t = "/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/obj_for_weighted_lnorm/AFL_obj_for_weighted_lnorm/afl_inputs/" + std::to_string(t) + "_weight_vec.qs";
