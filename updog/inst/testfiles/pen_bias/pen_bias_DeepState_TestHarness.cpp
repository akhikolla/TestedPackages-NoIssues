...
TEST(updog_deepstate_test,pen_bias_test){
  ...
  qs::c_qsave(h,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/pen_bias/inputs/h.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "h values: "<< h << std::endl;
  NumericVector mu_h(1);
  mu_h[0]  = RcppDeepState_double();
  qs::c_qsave(mu_h,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/pen_bias/inputs/mu_h.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mu_h values: "<< mu_h << std::endl;
  NumericVector sigma2_h(1);
  sigma2_h[0]  = RcppDeepState_double();
  qs::c_qsave(sigma2_h,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/pen_bias/inputs/sigma2_h.qs",
		"high", "zstd", 1, 15, true, 1);
