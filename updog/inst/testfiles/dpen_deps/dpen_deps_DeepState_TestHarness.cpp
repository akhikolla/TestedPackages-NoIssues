...
TEST(updog_deepstate_test,dpen_deps_test){
  ...
  qs::c_qsave(eps,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/dpen_deps/inputs/eps.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "eps values: "<< eps << std::endl;
  NumericVector mu_eps(1);
  mu_eps[0]  = RcppDeepState_double();
  qs::c_qsave(mu_eps,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/dpen_deps/inputs/mu_eps.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mu_eps values: "<< mu_eps << std::endl;
  NumericVector sigma2_eps(1);
  sigma2_eps[0]  = RcppDeepState_double();
  qs::c_qsave(sigma2_eps,"/home/akhila/fuzzer_packages/fuzzedpackages/updog/inst/testfiles/dpen_deps/inputs/sigma2_eps.qs",
		"high", "zstd", 1, 15, true, 1);
