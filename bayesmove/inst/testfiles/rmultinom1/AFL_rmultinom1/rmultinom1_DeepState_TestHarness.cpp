...
TEST(bayesmove_deepstate_test,rmultinom1_test){
  ...
  std::string prob_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bayesmove/inst/testfiles/rmultinom1/AFL_rmultinom1/afl_inputs/" + std::to_string(t) + "_prob.qs";
  qs::c_qsave(prob,prob_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "prob values: "<< prob << std::endl;
  NumericVector randu  = RcppDeepState_NumericVector();
  std::string randu_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bayesmove/inst/testfiles/rmultinom1/AFL_rmultinom1/afl_inputs/" + std::to_string(t) + "_randu.qs";
