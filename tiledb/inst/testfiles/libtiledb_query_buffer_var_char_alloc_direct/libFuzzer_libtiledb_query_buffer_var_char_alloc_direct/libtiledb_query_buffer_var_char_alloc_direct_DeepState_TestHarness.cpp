...
TEST(tiledb_deepstate_test,libtiledb_query_buffer_var_char_alloc_direct_test){
  ...
  std::string szoffsets_t = "/home/akhila/fuzzer_packages/fuzzedpackages/tiledb/inst/testfiles/libtiledb_query_buffer_var_char_alloc_direct/libFuzzer_libtiledb_query_buffer_var_char_alloc_direct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_szoffsets.qs";
  ...
  std::string szdata_t = "/home/akhila/fuzzer_packages/fuzzedpackages/tiledb/inst/testfiles/libtiledb_query_buffer_var_char_alloc_direct/libFuzzer_libtiledb_query_buffer_var_char_alloc_direct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_szdata.qs";
