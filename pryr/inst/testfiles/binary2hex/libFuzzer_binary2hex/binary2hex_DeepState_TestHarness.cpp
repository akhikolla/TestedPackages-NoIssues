...
TEST(pryr_deepstate_test,binary2hex_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/pryr/inst/testfiles/binary2hex/libFuzzer_binary2hex/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_x.qs";
  qs::c_qsave(x,x_t,
