...
TEST(ssdtools_deepstate_test,dlogis_ssd_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ssdtools/inst/testfiles/dlogis_ssd/AFL_dlogis_ssd/afl_inputs/" + std::to_string(t) + "_x.qs";
  qs::c_qsave(x,x_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x values: "<< x << std::endl;
  NumericVector location(1);
  location[0]  = RcppDeepState_double();
  std::string location_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ssdtools/inst/testfiles/dlogis_ssd/AFL_dlogis_ssd/afl_inputs/" + std::to_string(t) + "_location.qs";
  ...
  std::string scale_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ssdtools/inst/testfiles/dlogis_ssd/AFL_dlogis_ssd/afl_inputs/" + std::to_string(t) + "_scale.qs";
