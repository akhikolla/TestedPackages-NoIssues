...
TEST(ssdtools_deepstate_test,plnorm_ssd_test){
  ...
  std::string q_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ssdtools/inst/testfiles/plnorm_ssd/libFuzzer_plnorm_ssd/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_q.qs";
  qs::c_qsave(q,q_t,
  ...
  std::string meanlog_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ssdtools/inst/testfiles/plnorm_ssd/libFuzzer_plnorm_ssd/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_meanlog.qs";
  ...
  std::string sdlog_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ssdtools/inst/testfiles/plnorm_ssd/libFuzzer_plnorm_ssd/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_sdlog.qs";
