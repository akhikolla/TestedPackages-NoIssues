...
TEST(ssdtools_deepstate_test,pgumbel_ssd_test){
  ...
  qs::c_qsave(q,"/home/akhila/fuzzer_packages/fuzzedpackages/ssdtools/inst/testfiles/pgumbel_ssd/inputs/q.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "q values: "<< q << std::endl;
  NumericVector location(1);
  location[0]  = RcppDeepState_double();
  qs::c_qsave(location,"/home/akhila/fuzzer_packages/fuzzedpackages/ssdtools/inst/testfiles/pgumbel_ssd/inputs/location.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "location values: "<< location << std::endl;
  NumericVector scale(1);
  scale[0]  = RcppDeepState_double();
  qs::c_qsave(scale,"/home/akhila/fuzzer_packages/fuzzedpackages/ssdtools/inst/testfiles/pgumbel_ssd/inputs/scale.qs",
		"high", "zstd", 1, 15, true, 1);
