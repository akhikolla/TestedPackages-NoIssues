...
TEST(twosamples_deepstate_test,cvm_stat_test){
  ...
  qs::c_qsave(a,"/home/akhila/fuzzer_packages/fuzzedpackages/twosamples/inst/testfiles/cvm_stat/inputs/a.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "a values: "<< a << std::endl;
  NumericVector b  = RcppDeepState_NumericVector();
  qs::c_qsave(b,"/home/akhila/fuzzer_packages/fuzzedpackages/twosamples/inst/testfiles/cvm_stat/inputs/b.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "b values: "<< b << std::endl;
  NumericVector power(1);
  power[0]  = RcppDeepState_double();
  qs::c_qsave(power,"/home/akhila/fuzzer_packages/fuzzedpackages/twosamples/inst/testfiles/cvm_stat/inputs/power.qs",
		"high", "zstd", 1, 15, true, 1);
