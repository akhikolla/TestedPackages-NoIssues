...
TEST(QF_deepstate_test,compute_ak_nc_test){
  ...
  qs::c_qsave(lambdas,"/home/akhila/fuzzer_packages/fuzzedpackages/QF/inst/testfiles/compute_ak_nc/inputs/lambdas.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "lambdas values: "<< lambdas << std::endl;
  NumericVector etas  = RcppDeepState_NumericVector();
  qs::c_qsave(etas,"/home/akhila/fuzzer_packages/fuzzedpackages/QF/inst/testfiles/compute_ak_nc/inputs/etas.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "etas values: "<< etas << std::endl;
  IntegerVector maxit(1);
  maxit[0]  = RcppDeepState_int();
  qs::c_qsave(maxit,"/home/akhila/fuzzer_packages/fuzzedpackages/QF/inst/testfiles/compute_ak_nc/inputs/maxit.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "maxit values: "<< maxit << std::endl;
  NumericVector eps(1);
  eps[0]  = RcppDeepState_double();
  qs::c_qsave(eps,"/home/akhila/fuzzer_packages/fuzzedpackages/QF/inst/testfiles/compute_ak_nc/inputs/eps.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "eps values: "<< eps << std::endl;
  NumericVector beta(1);
  beta[0]  = RcppDeepState_double();
  qs::c_qsave(beta,"/home/akhila/fuzzer_packages/fuzzedpackages/QF/inst/testfiles/compute_ak_nc/inputs/beta.qs",
		"high", "zstd", 1, 15, true, 1);
