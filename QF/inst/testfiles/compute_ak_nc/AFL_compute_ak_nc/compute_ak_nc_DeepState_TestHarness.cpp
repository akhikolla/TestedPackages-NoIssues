...
TEST(QF_deepstate_test,compute_ak_nc_test){
  ...
  std::string lambdas_t = "/home/akhila/fuzzer_packages/fuzzedpackages/QF/inst/testfiles/compute_ak_nc/AFL_compute_ak_nc/afl_inputs/" + std::to_string(t) + "_lambdas.qs";
  qs::c_qsave(lambdas,lambdas_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "lambdas values: "<< lambdas << std::endl;
  NumericVector etas  = RcppDeepState_NumericVector();
  std::string etas_t = "/home/akhila/fuzzer_packages/fuzzedpackages/QF/inst/testfiles/compute_ak_nc/AFL_compute_ak_nc/afl_inputs/" + std::to_string(t) + "_etas.qs";
  qs::c_qsave(etas,etas_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "etas values: "<< etas << std::endl;
  IntegerVector maxit(1);
  maxit[0]  = RcppDeepState_int();
  std::string maxit_t = "/home/akhila/fuzzer_packages/fuzzedpackages/QF/inst/testfiles/compute_ak_nc/AFL_compute_ak_nc/afl_inputs/" + std::to_string(t) + "_maxit.qs";
  qs::c_qsave(maxit,maxit_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "maxit values: "<< maxit << std::endl;
  NumericVector eps(1);
  eps[0]  = RcppDeepState_double();
  std::string eps_t = "/home/akhila/fuzzer_packages/fuzzedpackages/QF/inst/testfiles/compute_ak_nc/AFL_compute_ak_nc/afl_inputs/" + std::to_string(t) + "_eps.qs";
  qs::c_qsave(eps,eps_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "eps values: "<< eps << std::endl;
  NumericVector beta(1);
  beta[0]  = RcppDeepState_double();
  std::string beta_t = "/home/akhila/fuzzer_packages/fuzzedpackages/QF/inst/testfiles/compute_ak_nc/AFL_compute_ak_nc/afl_inputs/" + std::to_string(t) + "_beta.qs";
