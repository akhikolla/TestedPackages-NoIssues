...
TEST(medfate_deepstate_test,EMCadsorption_test){
  ...
  std::string fuelTemperature_t = "/home/akhila/fuzzer_packages/fuzzedpackages/medfate/inst/testfiles/EMCadsorption/libFuzzer_EMCadsorption/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_fuelTemperature.qs";
  ...
  std::string fuelHumidity_t = "/home/akhila/fuzzer_packages/fuzzedpackages/medfate/inst/testfiles/EMCadsorption/libFuzzer_EMCadsorption/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_fuelHumidity.qs";
