...
TEST(medfate_deepstate_test,E2psiXylem_test){
  ...
  qs::c_qsave(E,"/home/akhila/fuzzer_packages/fuzzedpackages/medfate/inst/testfiles/E2psiXylem/inputs/E.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "E values: "<< E << std::endl;
  NumericVector psiUpstream(1);
  psiUpstream[0]  = RcppDeepState_double();
  qs::c_qsave(psiUpstream,"/home/akhila/fuzzer_packages/fuzzedpackages/medfate/inst/testfiles/E2psiXylem/inputs/psiUpstream.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "psiUpstream values: "<< psiUpstream << std::endl;
  NumericVector kxylemmax(1);
  kxylemmax[0]  = RcppDeepState_double();
  qs::c_qsave(kxylemmax,"/home/akhila/fuzzer_packages/fuzzedpackages/medfate/inst/testfiles/E2psiXylem/inputs/kxylemmax.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "kxylemmax values: "<< kxylemmax << std::endl;
  NumericVector c(1);
  c[0]  = RcppDeepState_double();
  qs::c_qsave(c,"/home/akhila/fuzzer_packages/fuzzedpackages/medfate/inst/testfiles/E2psiXylem/inputs/c.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "c values: "<< c << std::endl;
  NumericVector d(1);
  d[0]  = RcppDeepState_double();
  qs::c_qsave(d,"/home/akhila/fuzzer_packages/fuzzedpackages/medfate/inst/testfiles/E2psiXylem/inputs/d.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "d values: "<< d << std::endl;
  NumericVector psiCav(1);
  psiCav[0]  = RcppDeepState_double();
  qs::c_qsave(psiCav,"/home/akhila/fuzzer_packages/fuzzedpackages/medfate/inst/testfiles/E2psiXylem/inputs/psiCav.qs",
		"high", "zstd", 1, 15, true, 1);
