...
TEST(rlas_deepstate_test,fast_countover_test){
  ...
  qs::c_qsave(x,"/home/akhila/fuzzer_packages/fuzzedpackages/rlas/inst/testfiles/fast_countover/inputs/x.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x values: "<< x << std::endl;
  NumericVector t(1);
  t[0]  = RcppDeepState_double();
  qs::c_qsave(t,"/home/akhila/fuzzer_packages/fuzzedpackages/rlas/inst/testfiles/fast_countover/inputs/t.qs",
		"high", "zstd", 1, 15, true, 1);
