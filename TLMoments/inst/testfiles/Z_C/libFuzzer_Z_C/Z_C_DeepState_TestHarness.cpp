...
TEST(TLMoments_deepstate_test,Z_C_test){
  ...
  std::string maxr_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TLMoments/inst/testfiles/Z_C/libFuzzer_Z_C/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_maxr.qs";
