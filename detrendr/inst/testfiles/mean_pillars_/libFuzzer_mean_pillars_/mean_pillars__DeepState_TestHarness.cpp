...
TEST(detrendr_deepstate_test,mean_pillars__test){
  ...
  std::string arr3d_t = "/home/akhila/fuzzer_packages/fuzzedpackages/detrendr/inst/testfiles/mean_pillars_/libFuzzer_mean_pillars_/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_arr3d.qs";
