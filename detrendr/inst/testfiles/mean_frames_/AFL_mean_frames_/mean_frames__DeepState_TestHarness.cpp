...
TEST(detrendr_deepstate_test,mean_frames__test){
  ...
  std::string arr3d_t = "/home/akhila/fuzzer_packages/fuzzedpackages/detrendr/inst/testfiles/mean_frames_/AFL_mean_frames_/afl_inputs/" + std::to_string(t) + "_arr3d.qs";
