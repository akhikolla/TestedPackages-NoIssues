...
TEST(detrendr_deepstate_test,exp_smooth_pillars__test){
  ...
  std::string arr_t = "/home/akhila/fuzzer_packages/fuzzedpackages/detrendr/inst/testfiles/exp_smooth_pillars_/AFL_exp_smooth_pillars_/afl_inputs/" + std::to_string(t) + "_arr.qs";
  qs::c_qsave(arr,arr_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "arr values: "<< arr << std::endl;
  NumericVector tau(1);
  tau[0]  = RcppDeepState_double();
  std::string tau_t = "/home/akhila/fuzzer_packages/fuzzedpackages/detrendr/inst/testfiles/exp_smooth_pillars_/AFL_exp_smooth_pillars_/afl_inputs/" + std::to_string(t) + "_tau.qs";
  qs::c_qsave(tau,tau_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "tau values: "<< tau << std::endl;
  IntegerVector l(1);
  l[0]  = RcppDeepState_int();
  std::string l_t = "/home/akhila/fuzzer_packages/fuzzedpackages/detrendr/inst/testfiles/exp_smooth_pillars_/AFL_exp_smooth_pillars_/afl_inputs/" + std::to_string(t) + "_l.qs";
  qs::c_qsave(l,l_t,
		"high", "zstd", 1, 15, true, 1);
