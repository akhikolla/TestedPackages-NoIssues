...
TEST(detrendr_deepstate_test,px_take_mat_test){
  ...
  std::string mat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/detrendr/inst/testfiles/px_take_mat/libFuzzer_px_take_mat/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_mat.qs";
  ...
  std::string mat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/detrendr/inst/testfiles/px_take_mat/libFuzzer_px_take_mat/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_mat.qs";
  std::string mat_orig_t = "/home/akhila/fuzzer_packages/fuzzedpackages/detrendr/inst/testfiles/px_take_mat/libFuzzer_px_take_mat/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_mat_orig.qs";
  ...
  std::string frames_losing_t = "/home/akhila/fuzzer_packages/fuzzedpackages/detrendr/inst/testfiles/px_take_mat/libFuzzer_px_take_mat/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_frames_losing.qs";
  ...
  std::string seed_t = "/home/akhila/fuzzer_packages/fuzzedpackages/detrendr/inst/testfiles/px_take_mat/libFuzzer_px_take_mat/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_seed.qs";
