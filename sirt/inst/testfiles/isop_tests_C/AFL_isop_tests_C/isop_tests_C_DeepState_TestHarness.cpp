...
TEST(sirt_deepstate_test,isop_tests_C_test){
  ...
  std::string dat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/isop_tests_C/AFL_isop_tests_C/afl_inputs/" + std::to_string(t) + "_dat.qs";
  qs::c_qsave(dat,dat_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dat values: "<< dat << std::endl;
  NumericMatrix dat_resp  = RcppDeepState_NumericMatrix();
  std::string dat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/isop_tests_C/AFL_isop_tests_C/afl_inputs/" + std::to_string(t) + "_dat.qs";
  std::string dat_resp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/isop_tests_C/AFL_isop_tests_C/afl_inputs/" + std::to_string(t) + "_dat_resp.qs";
  ...
  std::string weights_t = "/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/isop_tests_C/AFL_isop_tests_C/afl_inputs/" + std::to_string(t) + "_weights.qs";
  qs::c_qsave(weights,weights_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "weights values: "<< weights << std::endl;
  NumericVector jackunits  = RcppDeepState_NumericVector();
  std::string jackunits_t = "/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/isop_tests_C/AFL_isop_tests_C/afl_inputs/" + std::to_string(t) + "_jackunits.qs";
  qs::c_qsave(jackunits,jackunits_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "jackunits values: "<< jackunits << std::endl;
  IntegerVector JJ(1);
  JJ[0]  = RcppDeepState_int();
  std::string JJ_t = "/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/isop_tests_C/AFL_isop_tests_C/afl_inputs/" + std::to_string(t) + "_JJ.qs";
  qs::c_qsave(JJ,JJ_t,
		"high", "zstd", 1, 15, true, 1);
