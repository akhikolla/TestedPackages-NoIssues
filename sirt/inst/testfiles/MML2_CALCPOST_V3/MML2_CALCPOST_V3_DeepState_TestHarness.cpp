...
TEST(sirt_deepstate_test,MML2_CALCPOST_V3_test){
  ...
  qs::c_qsave(DAT2,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/MML2_CALCPOST_V3/inputs/DAT2.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "DAT2 values: "<< DAT2 << std::endl;
  NumericMatrix DAT2RESP  = RcppDeepState_NumericMatrix();
  qs::c_qsave(DAT2RESP,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/MML2_CALCPOST_V3/inputs/DAT2RESP.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "DAT2RESP values: "<< DAT2RESP << std::endl;
  NumericMatrix PROBS  = RcppDeepState_NumericMatrix();
  qs::c_qsave(PROBS,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/MML2_CALCPOST_V3/inputs/PROBS.qs",
		"high", "zstd", 1, 15, true, 1);
