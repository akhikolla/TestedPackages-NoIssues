...
TEST(sirt_deepstate_test,SMIRT_CALCPROB_NONCOMP_test){
  ...
  qs::c_qsave(A,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/SMIRT_CALCPROB_NONCOMP/inputs/A.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "A values: "<< A << std::endl;
  NumericMatrix B  = RcppDeepState_NumericMatrix();
  qs::c_qsave(B,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/SMIRT_CALCPROB_NONCOMP/inputs/B.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "B values: "<< B << std::endl;
  NumericMatrix QQ  = RcppDeepState_NumericMatrix();
  qs::c_qsave(QQ,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/SMIRT_CALCPROB_NONCOMP/inputs/QQ.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "QQ values: "<< QQ << std::endl;
  NumericMatrix THETA  = RcppDeepState_NumericMatrix();
  qs::c_qsave(THETA,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/SMIRT_CALCPROB_NONCOMP/inputs/THETA.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "THETA values: "<< THETA << std::endl;
  NumericVector CC  = RcppDeepState_NumericVector();
  qs::c_qsave(CC,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/SMIRT_CALCPROB_NONCOMP/inputs/CC.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "CC values: "<< CC << std::endl;
  NumericVector DD  = RcppDeepState_NumericVector();
  qs::c_qsave(DD,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/SMIRT_CALCPROB_NONCOMP/inputs/DD.qs",
		"high", "zstd", 1, 15, true, 1);
