...
TEST(sirt_deepstate_test,mle_pcm_C_test){
  ...
  qs::c_qsave(dat,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/mle_pcm_C/inputs/dat.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dat values: "<< dat << std::endl;
  NumericMatrix dat_resp  = RcppDeepState_NumericMatrix();
  qs::c_qsave(dat_resp,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/mle_pcm_C/inputs/dat_resp.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dat_resp values: "<< dat_resp << std::endl;
  NumericMatrix b  = RcppDeepState_NumericMatrix();
  qs::c_qsave(b,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/mle_pcm_C/inputs/b.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "b values: "<< b << std::endl;
  NumericVector a  = RcppDeepState_NumericVector();
  qs::c_qsave(a,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/mle_pcm_C/inputs/a.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "a values: "<< a << std::endl;
  NumericVector maxK  = RcppDeepState_NumericVector();
  qs::c_qsave(maxK,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/mle_pcm_C/inputs/maxK.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "maxK values: "<< maxK << std::endl;
  NumericVector theta0  = RcppDeepState_NumericVector();
  qs::c_qsave(theta0,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/mle_pcm_C/inputs/theta0.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "theta0 values: "<< theta0 << std::endl;
  NumericVector conv(1);
  conv[0]  = RcppDeepState_double();
  qs::c_qsave(conv,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/mle_pcm_C/inputs/conv.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "conv values: "<< conv << std::endl;
  IntegerVector maxiter(1);
  maxiter[0]  = RcppDeepState_int();
  qs::c_qsave(maxiter,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/mle_pcm_C/inputs/maxiter.qs",
		"high", "zstd", 1, 15, true, 1);
