...
TEST(sirt_deepstate_test,probs_pcm_groups_C_test){
  ...
  qs::c_qsave(dat,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/probs_pcm_groups_C/inputs/dat.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dat values: "<< dat << std::endl;
  NumericMatrix dat_resp  = RcppDeepState_NumericMatrix();
  qs::c_qsave(dat_resp,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/probs_pcm_groups_C/inputs/dat_resp.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dat_resp values: "<< dat_resp << std::endl;
  NumericVector group  = RcppDeepState_NumericVector();
  qs::c_qsave(group,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/probs_pcm_groups_C/inputs/group.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "group values: "<< group << std::endl;
  NumericMatrix probs  = RcppDeepState_NumericMatrix();
  qs::c_qsave(probs,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/probs_pcm_groups_C/inputs/probs.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "probs values: "<< probs << std::endl;
  IntegerVector CC(1);
  CC[0]  = RcppDeepState_int();
  qs::c_qsave(CC,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/probs_pcm_groups_C/inputs/CC.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "CC values: "<< CC << std::endl;
  IntegerVector TP(1);
  TP[0]  = RcppDeepState_int();
  qs::c_qsave(TP,"/home/akhila/fuzzer_packages/fuzzedpackages/sirt/inst/testfiles/probs_pcm_groups_C/inputs/TP.qs",
		"high", "zstd", 1, 15, true, 1);
