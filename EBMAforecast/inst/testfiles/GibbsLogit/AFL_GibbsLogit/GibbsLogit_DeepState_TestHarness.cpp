...
TEST(EBMAforecast_deepstate_test,GibbsLogit_test){
  ...
  std::string outcome_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EBMAforecast/inst/testfiles/GibbsLogit/AFL_GibbsLogit/afl_inputs/" + std::to_string(t) + "_outcome.qs";
  ...
  std::string prediction_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EBMAforecast/inst/testfiles/GibbsLogit/AFL_GibbsLogit/afl_inputs/" + std::to_string(t) + "_prediction.qs";
  qs::c_qsave(prediction,prediction_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "prediction values: "<< prediction << std::endl;
  NumericVector W  = RcppDeepState_NumericVector();
  std::string W_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EBMAforecast/inst/testfiles/GibbsLogit/AFL_GibbsLogit/afl_inputs/" + std::to_string(t) + "_W.qs";
  qs::c_qsave(W,W_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "W values: "<< W << std::endl;
  IntegerVector iterations(1);
  iterations[0]  = RcppDeepState_int();
  std::string iterations_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EBMAforecast/inst/testfiles/GibbsLogit/AFL_GibbsLogit/afl_inputs/" + std::to_string(t) + "_iterations.qs";
  ...
  std::string burnin_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EBMAforecast/inst/testfiles/GibbsLogit/AFL_GibbsLogit/afl_inputs/" + std::to_string(t) + "_burnin.qs";
  qs::c_qsave(burnin,burnin_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "burnin values: "<< burnin << std::endl;
  IntegerVector thin(1);
  thin[0]  = RcppDeepState_int();
  std::string thin_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EBMAforecast/inst/testfiles/GibbsLogit/AFL_GibbsLogit/afl_inputs/" + std::to_string(t) + "_thin.qs";
