...
TEST(EloChoice_deepstate_test,elointnorm_test){
  ...
  std::string winner_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/elointnorm/AFL_elointnorm/afl_inputs/" + std::to_string(t) + "_winner.qs";
  qs::c_qsave(winner,winner_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "winner values: "<< winner << std::endl;
  CharacterVector loser  = RcppDeepState_CharacterVector();
  std::string loser_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/elointnorm/AFL_elointnorm/afl_inputs/" + std::to_string(t) + "_loser.qs";
  qs::c_qsave(loser,loser_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "loser values: "<< loser << std::endl;
  CharacterVector allids  = RcppDeepState_CharacterVector();
  std::string allids_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/elointnorm/AFL_elointnorm/afl_inputs/" + std::to_string(t) + "_allids.qs";
  qs::c_qsave(allids,allids_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "allids values: "<< allids << std::endl;
  NumericVector kval  = RcppDeepState_NumericVector();
  std::string kval_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/elointnorm/AFL_elointnorm/afl_inputs/" + std::to_string(t) + "_kval.qs";
  qs::c_qsave(kval,kval_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "kval values: "<< kval << std::endl;
  NumericVector startvalues  = RcppDeepState_NumericVector();
  std::string startvalues_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/elointnorm/AFL_elointnorm/afl_inputs/" + std::to_string(t) + "_startvalues.qs";
  ...
  std::string runs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/elointnorm/AFL_elointnorm/afl_inputs/" + std::to_string(t) + "_runs.qs";
