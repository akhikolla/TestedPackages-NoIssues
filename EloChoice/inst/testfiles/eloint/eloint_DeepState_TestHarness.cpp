...
TEST(EloChoice_deepstate_test,eloint_test){
  ...
  qs::c_qsave(winner,"/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/eloint/inputs/winner.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "winner values: "<< winner << std::endl;
  CharacterVector loser  = RcppDeepState_CharacterVector();
  qs::c_qsave(loser,"/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/eloint/inputs/loser.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "loser values: "<< loser << std::endl;
  CharacterVector allids  = RcppDeepState_CharacterVector();
  qs::c_qsave(allids,"/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/eloint/inputs/allids.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "allids values: "<< allids << std::endl;
  NumericVector kval  = RcppDeepState_NumericVector();
  qs::c_qsave(kval,"/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/eloint/inputs/kval.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "kval values: "<< kval << std::endl;
  NumericVector startvalues  = RcppDeepState_NumericVector();
  qs::c_qsave(startvalues,"/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/eloint/inputs/startvalues.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "startvalues values: "<< startvalues << std::endl;
  NumericVector runs  = RcppDeepState_NumericVector();
  qs::c_qsave(runs,"/home/akhila/fuzzer_packages/fuzzedpackages/EloChoice/inst/testfiles/eloint/inputs/runs.qs",
		"high", "zstd", 1, 15, true, 1);
