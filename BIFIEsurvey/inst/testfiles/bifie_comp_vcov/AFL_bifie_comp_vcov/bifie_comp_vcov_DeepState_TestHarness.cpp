...
TEST(BIFIEsurvey_deepstate_test,bifie_comp_vcov_test){
  ...
  std::string parsM_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_comp_vcov/AFL_bifie_comp_vcov/afl_inputs/" + std::to_string(t) + "_parsM.qs";
  qs::c_qsave(parsM,parsM_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "parsM values: "<< parsM << std::endl;
  NumericMatrix parsrepM  = RcppDeepState_NumericMatrix();
  std::string parsrepM_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_comp_vcov/AFL_bifie_comp_vcov/afl_inputs/" + std::to_string(t) + "_parsrepM.qs";
  qs::c_qsave(parsrepM,parsrepM_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "parsrepM values: "<< parsrepM << std::endl;
  NumericMatrix Cdes  = RcppDeepState_NumericMatrix();
  std::string Cdes_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_comp_vcov/AFL_bifie_comp_vcov/afl_inputs/" + std::to_string(t) + "_Cdes.qs";
  qs::c_qsave(Cdes,Cdes_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Cdes values: "<< Cdes << std::endl;
  NumericVector rdes  = RcppDeepState_NumericVector();
  std::string rdes_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_comp_vcov/AFL_bifie_comp_vcov/afl_inputs/" + std::to_string(t) + "_rdes.qs";
  qs::c_qsave(rdes,rdes_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "rdes values: "<< rdes << std::endl;
  NumericVector Ccols  = RcppDeepState_NumericVector();
  std::string Ccols_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_comp_vcov/AFL_bifie_comp_vcov/afl_inputs/" + std::to_string(t) + "_Ccols.qs";
  qs::c_qsave(Ccols,Ccols_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Ccols values: "<< Ccols << std::endl;
  NumericVector fayfac  = RcppDeepState_NumericVector();
  std::string fayfac_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_comp_vcov/AFL_bifie_comp_vcov/afl_inputs/" + std::to_string(t) + "_fayfac.qs";
