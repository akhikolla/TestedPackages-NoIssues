...
TEST(BIFIEsurvey_deepstate_test,bifie_freq_test){
  ...
  qs::c_qsave(datalist,"/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_freq/inputs/datalist.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "datalist values: "<< datalist << std::endl;
  NumericMatrix wgt1  = RcppDeepState_NumericMatrix();
  qs::c_qsave(wgt1,"/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_freq/inputs/wgt1.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "wgt1 values: "<< wgt1 << std::endl;
  NumericMatrix wgtrep  = RcppDeepState_NumericMatrix();
  qs::c_qsave(wgtrep,"/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_freq/inputs/wgtrep.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "wgtrep values: "<< wgtrep << std::endl;
  NumericVector vars_index  = RcppDeepState_NumericVector();
  qs::c_qsave(vars_index,"/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_freq/inputs/vars_index.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "vars_index values: "<< vars_index << std::endl;
  NumericVector fayfac  = RcppDeepState_NumericVector();
  qs::c_qsave(fayfac,"/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_freq/inputs/fayfac.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "fayfac values: "<< fayfac << std::endl;
  NumericVector NI  = RcppDeepState_NumericVector();
  qs::c_qsave(NI,"/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_freq/inputs/NI.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "NI values: "<< NI << std::endl;
  NumericVector group_index1  = RcppDeepState_NumericVector();
  qs::c_qsave(group_index1,"/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_freq/inputs/group_index1.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "group_index1 values: "<< group_index1 << std::endl;
  NumericVector group_values  = RcppDeepState_NumericVector();
  qs::c_qsave(group_values,"/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_freq/inputs/group_values.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "group_values values: "<< group_values << std::endl;
  NumericMatrix vars_values  = RcppDeepState_NumericMatrix();
  qs::c_qsave(vars_values,"/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_freq/inputs/vars_values.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "vars_values values: "<< vars_values << std::endl;
  NumericVector vars_values_numb  = RcppDeepState_NumericVector();
  qs::c_qsave(vars_values_numb,"/home/akhila/fuzzer_packages/fuzzedpackages/BIFIEsurvey/inst/testfiles/bifie_freq/inputs/vars_values_numb.qs",
		"high", "zstd", 1, 15, true, 1);
