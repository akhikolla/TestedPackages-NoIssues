...
TEST(ICcalib_deepstate_test,CalcSurvFromNPMLE_test){
  ...
  std::string probs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ICcalib/inst/testfiles/CalcSurvFromNPMLE/libFuzzer_CalcSurvFromNPMLE/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_probs.qs";
  qs::c_qsave(probs,probs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "probs values: "<< probs << std::endl;
  NumericVector points  = RcppDeepState_NumericVector();
  std::string points_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ICcalib/inst/testfiles/CalcSurvFromNPMLE/libFuzzer_CalcSurvFromNPMLE/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_points.qs";
  qs::c_qsave(points,points_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "points values: "<< points << std::endl;
  NumericMatrix Tbull  = RcppDeepState_NumericMatrix();
  std::string Tbull_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ICcalib/inst/testfiles/CalcSurvFromNPMLE/libFuzzer_CalcSurvFromNPMLE/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_Tbull.qs";
