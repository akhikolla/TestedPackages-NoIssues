...
TEST(xdcclarge_deepstate_test,cdcc_construct_test){
  ...
  qs::c_qsave(alpha,"/home/akhila/fuzzer_packages/fuzzedpackages/xdcclarge/inst/testfiles/cdcc_construct/inputs/alpha.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "alpha values: "<< alpha << std::endl;
  NumericVector beta(1);
  beta[0]  = RcppDeepState_double();
  qs::c_qsave(beta,"/home/akhila/fuzzer_packages/fuzzedpackages/xdcclarge/inst/testfiles/cdcc_construct/inputs/beta.qs",
		"high", "zstd", 1, 15, true, 1);
  ...
  qs::c_qsave(nobs,"/home/akhila/fuzzer_packages/fuzzedpackages/xdcclarge/inst/testfiles/cdcc_construct/inputs/nobs.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nobs values: "<< nobs << std::endl;
  IntegerVector ndim(1);
  ndim[0]  = RcppDeepState_int();
  qs::c_qsave(ndim,"/home/akhila/fuzzer_packages/fuzzedpackages/xdcclarge/inst/testfiles/cdcc_construct/inputs/ndim.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ndim values: "<< ndim << std::endl;
  IntegerVector ts(1);
  ts[0]  = RcppDeepState_int();
  qs::c_qsave(ts,"/home/akhila/fuzzer_packages/fuzzedpackages/xdcclarge/inst/testfiles/cdcc_construct/inputs/ts.qs",
		"high", "zstd", 1, 15, true, 1);
