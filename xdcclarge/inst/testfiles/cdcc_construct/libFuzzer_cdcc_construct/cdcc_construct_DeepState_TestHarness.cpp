...
TEST(xdcclarge_deepstate_test,cdcc_construct_test){
  ...
  std::string alpha_t = "/home/akhila/fuzzer_packages/fuzzedpackages/xdcclarge/inst/testfiles/cdcc_construct/libFuzzer_cdcc_construct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_alpha.qs";
  ...
  std::string beta_t = "/home/akhila/fuzzer_packages/fuzzedpackages/xdcclarge/inst/testfiles/cdcc_construct/libFuzzer_cdcc_construct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_beta.qs";
  ...
  std::string nobs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/xdcclarge/inst/testfiles/cdcc_construct/libFuzzer_cdcc_construct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_nobs.qs";
  ...
  std::string ndim_t = "/home/akhila/fuzzer_packages/fuzzedpackages/xdcclarge/inst/testfiles/cdcc_construct/libFuzzer_cdcc_construct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ndim.qs";
  ...
  std::string ts_t = "/home/akhila/fuzzer_packages/fuzzedpackages/xdcclarge/inst/testfiles/cdcc_construct/libFuzzer_cdcc_construct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ts.qs";
  qs::c_qsave(ts,ts_t,
		"high", "zstd", 1, 15, true, 1);
