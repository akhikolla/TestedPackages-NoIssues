...
TEST(CARBayesST_deepstate_test,update_Qtime_test){
  ...
  std::string Qtime_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CARBayesST/inst/testfiles/update_Qtime/AFL_update_Qtime/afl_inputs/" + std::to_string(t) + "_Qtime.qs";
  qs::c_qsave(Qtime,Qtime_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Qtime values: "<< Qtime << std::endl;
  NumericVector alpha(1);
  alpha[0]  = RcppDeepState_double();
  std::string alpha_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CARBayesST/inst/testfiles/update_Qtime/AFL_update_Qtime/afl_inputs/" + std::to_string(t) + "_alpha.qs";
  qs::c_qsave(alpha,alpha_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "alpha values: "<< alpha << std::endl;
  IntegerVector rowNumberLastDiag(1);
  rowNumberLastDiag[0]  = RcppDeepState_int();
  std::string rowNumberLastDiag_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CARBayesST/inst/testfiles/update_Qtime/AFL_update_Qtime/afl_inputs/" + std::to_string(t) + "_rowNumberLastDiag.qs";
