...
TEST(StMoSim_deepstate_test,myQQNormIntern_test){
  ...
  std::string mySeq_t = "/home/akhila/fuzzer_packages/fuzzedpackages/StMoSim/inst/testfiles/myQQNormIntern/AFL_myQQNormIntern/afl_inputs/" + std::to_string(t) + "_mySeq.qs";
  qs::c_qsave(mySeq,mySeq_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mySeq values: "<< mySeq << std::endl;
  NumericVector myMean(1);
  myMean[0]  = RcppDeepState_double();
  std::string myMean_t = "/home/akhila/fuzzer_packages/fuzzedpackages/StMoSim/inst/testfiles/myQQNormIntern/AFL_myQQNormIntern/afl_inputs/" + std::to_string(t) + "_myMean.qs";
  qs::c_qsave(myMean,myMean_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "myMean values: "<< myMean << std::endl;
  NumericVector mySd(1);
  mySd[0]  = RcppDeepState_double();
  std::string mySd_t = "/home/akhila/fuzzer_packages/fuzzedpackages/StMoSim/inst/testfiles/myQQNormIntern/AFL_myQQNormIntern/afl_inputs/" + std::to_string(t) + "_mySd.qs";
  qs::c_qsave(mySd,mySd_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mySd values: "<< mySd << std::endl;
  NumericVector lengthX(1);
  lengthX[0]  = RcppDeepState_double();
  std::string lengthX_t = "/home/akhila/fuzzer_packages/fuzzedpackages/StMoSim/inst/testfiles/myQQNormIntern/AFL_myQQNormIntern/afl_inputs/" + std::to_string(t) + "_lengthX.qs";
  qs::c_qsave(lengthX,lengthX_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "lengthX values: "<< lengthX << std::endl;
  IntegerVector n_sim(1);
  n_sim[0]  = RcppDeepState_int();
  std::string n_sim_t = "/home/akhila/fuzzer_packages/fuzzedpackages/StMoSim/inst/testfiles/myQQNormIntern/AFL_myQQNormIntern/afl_inputs/" + std::to_string(t) + "_n_sim.qs";
