...
TEST(EstMix_deepstate_test,calcll_baf_test){
  ...
  std::string lrr_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EstMix/inst/testfiles/calcll_baf/AFL_calcll_baf/afl_inputs/" + std::to_string(t) + "_lrr.qs";
  qs::c_qsave(lrr,lrr_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "lrr values: "<< lrr << std::endl;
  NumericVector nrc(1);
  nrc[0]  = RcppDeepState_double();
  std::string nrc_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EstMix/inst/testfiles/calcll_baf/AFL_calcll_baf/afl_inputs/" + std::to_string(t) + "_nrc.qs";
  qs::c_qsave(nrc,nrc_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nrc values: "<< nrc << std::endl;
  NumericVector baf(1);
  baf[0]  = RcppDeepState_double();
  std::string baf_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EstMix/inst/testfiles/calcll_baf/AFL_calcll_baf/afl_inputs/" + std::to_string(t) + "_baf.qs";
  qs::c_qsave(baf,baf_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "baf values: "<< baf << std::endl;
  NumericVector n_baf(1);
  n_baf[0]  = RcppDeepState_double();
  std::string n_baf_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EstMix/inst/testfiles/calcll_baf/AFL_calcll_baf/afl_inputs/" + std::to_string(t) + "_n_baf.qs";
  ...
  std::string scale_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EstMix/inst/testfiles/calcll_baf/AFL_calcll_baf/afl_inputs/" + std::to_string(t) + "_scale.qs";
  qs::c_qsave(scale,scale_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "scale values: "<< scale << std::endl;
  IntegerVector pscnMax(1);
  pscnMax[0]  = RcppDeepState_int();
  std::string pscnMax_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EstMix/inst/testfiles/calcll_baf/AFL_calcll_baf/afl_inputs/" + std::to_string(t) + "_pscnMax.qs";
  qs::c_qsave(pscnMax,pscnMax_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "pscnMax values: "<< pscnMax << std::endl;
  IntegerVector MaxCn(1);
  MaxCn[0]  = RcppDeepState_int();
  std::string MaxCn_t = "/home/akhila/fuzzer_packages/fuzzedpackages/EstMix/inst/testfiles/calcll_baf/AFL_calcll_baf/afl_inputs/" + std::to_string(t) + "_MaxCn.qs";
