...
TEST(PoissonBinomial_deepstate_test,dgpb_conv_test){
  ...
  qs::c_qsave(obs,"/home/akhila/fuzzer_packages/fuzzedpackages/PoissonBinomial/inst/testfiles/dgpb_conv/inputs/obs.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "obs values: "<< obs << std::endl;
  NumericVector probs  = RcppDeepState_NumericVector();
  qs::c_qsave(probs,"/home/akhila/fuzzer_packages/fuzzedpackages/PoissonBinomial/inst/testfiles/dgpb_conv/inputs/probs.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "probs values: "<< probs << std::endl;
  IntegerVector val_p  = RcppDeepState_IntegerVector();
  qs::c_qsave(val_p,"/home/akhila/fuzzer_packages/fuzzedpackages/PoissonBinomial/inst/testfiles/dgpb_conv/inputs/val_p.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "val_p values: "<< val_p << std::endl;
  IntegerVector val_q  = RcppDeepState_IntegerVector();
  qs::c_qsave(val_q,"/home/akhila/fuzzer_packages/fuzzedpackages/PoissonBinomial/inst/testfiles/dgpb_conv/inputs/val_q.qs",
		"high", "zstd", 1, 15, true, 1);
