...
TEST(PoissonBinomial_deepstate_test,dgpb_conv_test){
  ...
  std::string obs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PoissonBinomial/inst/testfiles/dgpb_conv/AFL_dgpb_conv/afl_inputs/" + std::to_string(t) + "_obs.qs";
  qs::c_qsave(obs,obs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "obs values: "<< obs << std::endl;
  NumericVector probs  = RcppDeepState_NumericVector();
  std::string probs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PoissonBinomial/inst/testfiles/dgpb_conv/AFL_dgpb_conv/afl_inputs/" + std::to_string(t) + "_probs.qs";
  qs::c_qsave(probs,probs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "probs values: "<< probs << std::endl;
  IntegerVector val_p  = RcppDeepState_IntegerVector();
  std::string val_p_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PoissonBinomial/inst/testfiles/dgpb_conv/AFL_dgpb_conv/afl_inputs/" + std::to_string(t) + "_val_p.qs";
  qs::c_qsave(val_p,val_p_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "val_p values: "<< val_p << std::endl;
  IntegerVector val_q  = RcppDeepState_IntegerVector();
  std::string val_q_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PoissonBinomial/inst/testfiles/dgpb_conv/AFL_dgpb_conv/afl_inputs/" + std::to_string(t) + "_val_q.qs";
