...
TEST(PoissonBinomial_deepstate_test,dpb_dftcf_test){
  ...
  std::string obs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PoissonBinomial/inst/testfiles/dpb_dftcf/libFuzzer_dpb_dftcf/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_obs.qs";
  qs::c_qsave(obs,obs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "obs values: "<< obs << std::endl;
  NumericVector probs  = RcppDeepState_NumericVector();
  std::string probs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PoissonBinomial/inst/testfiles/dpb_dftcf/libFuzzer_dpb_dftcf/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_probs.qs";
