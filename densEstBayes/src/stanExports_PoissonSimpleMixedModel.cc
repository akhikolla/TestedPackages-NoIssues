...
#include "stanExports_PoissonSimpleMixedModel.h"

RCPP_MODULE(stan_fit4PoissonSimpleMixedModel_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_PoissonSimpleMixedModel")
