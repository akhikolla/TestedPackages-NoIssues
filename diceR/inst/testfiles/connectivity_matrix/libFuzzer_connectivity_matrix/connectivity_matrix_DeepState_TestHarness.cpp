...
TEST(diceR_deepstate_test,connectivity_matrix_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/diceR/inst/testfiles/connectivity_matrix/libFuzzer_connectivity_matrix/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_x.qs";
  qs::c_qsave(x,x_t,
