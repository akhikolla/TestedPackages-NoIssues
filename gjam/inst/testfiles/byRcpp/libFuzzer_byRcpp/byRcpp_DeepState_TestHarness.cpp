...
TEST(gjam_deepstate_test,byRcpp_test){
  ...
  std::string nr_t = "/home/akhila/fuzzer_packages/fuzzedpackages/gjam/inst/testfiles/byRcpp/libFuzzer_byRcpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_nr.qs";
  qs::c_qsave(nr,nr_t,
