...
set(SYMENGINE_CXX_FLAGS "-std=c++11 -g -O2 -fdebug-prefix-map=/build/r-base-8T8CYO/r-base-4.0.3=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -fPIC")
set(SYMENGINE_CXX_FLAGS_RELEASE "-Wall -Wextra -fno-common -O3 -funroll-loops")
set(SYMENGINE_CXX_FLAGS_DEBUG "-Wall -Wextra -fno-common -g -ggdb")
set(SYMENGINE_C_FLAGS "-g -O2 -fdebug-prefix-map=/build/r-base-8T8CYO/r-base-4.0.3=. -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g")
...
if(SYMENGINE_BUILD_TREE)
    ...
    set(SYMENGINE_INCLUDE_DIRS /home/akhila/fuzzer_packages/fuzzedpackages/symengine/src/upstream;/home/akhila/fuzzer_packages/fuzzedpackages/symengine/src/upstream ${SYMENGINE_CMAKE_DIR})
    if (TARGET teuchos)
