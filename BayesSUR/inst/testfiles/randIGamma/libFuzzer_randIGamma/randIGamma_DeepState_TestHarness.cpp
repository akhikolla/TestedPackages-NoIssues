...
TEST(BayesSUR_deepstate_test,randIGamma_test){
  ...
  std::string shape_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BayesSUR/inst/testfiles/randIGamma/libFuzzer_randIGamma/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_shape.qs";
  ...
  std::string scale_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BayesSUR/inst/testfiles/randIGamma/libFuzzer_randIGamma/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_scale.qs";
