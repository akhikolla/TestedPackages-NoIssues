...
TEST(cutpointr_deepstate_test,one_unique_char_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/cutpointr/inst/testfiles/one_unique_char/AFL_one_unique_char/afl_inputs/" + std::to_string(t) + "_x.qs";
  qs::c_qsave(x,x_t,
