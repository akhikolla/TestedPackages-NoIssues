...
TEST(cutpointr_deepstate_test,is_equal_cpp_num_test){
  ...
  qs::c_qsave(x,"/home/akhila/fuzzer_packages/fuzzedpackages/cutpointr/inst/testfiles/is_equal_cpp_num/inputs/x.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x values: "<< x << std::endl;
  NumericVector y(1);
  y[0]  = RcppDeepState_double();
  qs::c_qsave(y,"/home/akhila/fuzzer_packages/fuzzedpackages/cutpointr/inst/testfiles/is_equal_cpp_num/inputs/y.qs",
		"high", "zstd", 1, 15, true, 1);
