...
TEST(esreg_deepstate_test,G1_fun_test){
  ...
  qs::c_qsave(z,"/home/akhila/fuzzer_packages/fuzzedpackages/esreg/inst/testfiles/G1_fun/inputs/z.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "z values: "<< z << std::endl;
  IntegerVector type(1);
  type[0]  = RcppDeepState_int();
  qs::c_qsave(type,"/home/akhila/fuzzer_packages/fuzzedpackages/esreg/inst/testfiles/G1_fun/inputs/type.qs",
		"high", "zstd", 1, 15, true, 1);
