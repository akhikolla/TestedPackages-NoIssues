...
TEST(gapfill_deepstate_test,Score_cpp_test){
  ...
  std::string mat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/gapfill/inst/testfiles/Score_cpp/libFuzzer_Score_cpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_mat.qs";
