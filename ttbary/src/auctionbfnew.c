/*
   ...
   $Revision: 0.5 $   $Date: 2019/02/28 02:33:00 $
...
#include "auctionbfnew.h" // for good style, but not strictly necessary
...
void auctionbf2(int *desirem, int *nn, int *pers_to_obj, int *obj_to_pers, double *price, double *profit, int *kk, double *eps)
{
   int i,j,r; /* indices */
   int k,n;
   State state;
   ...
   state.obj_to_pers = obj_to_pers;      /* n vector: object j assigned to which person */
