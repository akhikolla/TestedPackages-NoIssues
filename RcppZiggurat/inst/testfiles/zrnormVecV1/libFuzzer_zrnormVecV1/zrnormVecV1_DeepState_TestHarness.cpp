...
TEST(RcppZiggurat_deepstate_test,zrnormVecV1_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RcppZiggurat/inst/testfiles/zrnormVecV1/libFuzzer_zrnormVecV1/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_x.qs";
  qs::c_qsave(x,x_t,
