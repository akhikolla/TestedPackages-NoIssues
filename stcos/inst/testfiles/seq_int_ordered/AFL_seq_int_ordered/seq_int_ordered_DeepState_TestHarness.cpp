...
TEST(stcos_deepstate_test,seq_int_ordered_test){
  ...
  std::string from_t = "/home/akhila/fuzzer_packages/fuzzedpackages/stcos/inst/testfiles/seq_int_ordered/AFL_seq_int_ordered/afl_inputs/" + std::to_string(t) + "_from.qs";
  qs::c_qsave(from,from_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "from values: "<< from << std::endl;
  NumericVector to(1);
  to[0]  = RcppDeepState_double();
  std::string to_t = "/home/akhila/fuzzer_packages/fuzzedpackages/stcos/inst/testfiles/seq_int_ordered/AFL_seq_int_ordered/afl_inputs/" + std::to_string(t) + "_to.qs";
  qs::c_qsave(to,to_t,
		"high", "zstd", 1, 15, true, 1);
