...
TEST(satellite_deepstate_test,ScatteringModel_test){
  ...
  std::string mnBandWls_t = "/home/akhila/fuzzer_packages/fuzzedpackages/satellite/inst/testfiles/ScatteringModel/AFL_ScatteringModel/afl_inputs/" + std::to_string(t) + "_mnBandWls.qs";
  ...
  std::string dScatCoef_t = "/home/akhila/fuzzer_packages/fuzzedpackages/satellite/inst/testfiles/ScatteringModel/AFL_ScatteringModel/afl_inputs/" + std::to_string(t) + "_dScatCoef.qs";
