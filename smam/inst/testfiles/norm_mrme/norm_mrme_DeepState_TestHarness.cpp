...
TEST(smam_deepstate_test,norm_mrme_test){
  ...
  qs::c_qsave(z,"/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/norm_mrme/inputs/z.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "z values: "<< z << std::endl;
  NumericVector b(1);
  b[0]  = RcppDeepState_double();
  qs::c_qsave(b,"/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/norm_mrme/inputs/b.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "b values: "<< b << std::endl;
  NumericVector d(1);
  d[0]  = RcppDeepState_double();
  qs::c_qsave(d,"/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/norm_mrme/inputs/d.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "d values: "<< d << std::endl;
  NumericVector integrControl  = RcppDeepState_NumericVector();
  qs::c_qsave(integrControl,"/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/norm_mrme/inputs/integrControl.qs",
		"high", "zstd", 1, 15, true, 1);
