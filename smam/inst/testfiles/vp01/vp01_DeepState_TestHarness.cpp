...
TEST(smam_deepstate_test,vp01_test){
  ...
  qs::c_qsave(vw,"/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/vp01/inputs/vw.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "vw values: "<< vw << std::endl;
  NumericVector t(1);
  t[0]  = RcppDeepState_double();
  qs::c_qsave(t,"/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/vp01/inputs/t.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "t values: "<< t << std::endl;
  NumericVector lambda1(1);
  lambda1[0]  = RcppDeepState_double();
  qs::c_qsave(lambda1,"/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/vp01/inputs/lambda1.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "lambda1 values: "<< lambda1 << std::endl;
  NumericVector lambda0(1);
  lambda0[0]  = RcppDeepState_double();
  qs::c_qsave(lambda0,"/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/vp01/inputs/lambda0.qs",
		"high", "zstd", 1, 15, true, 1);
