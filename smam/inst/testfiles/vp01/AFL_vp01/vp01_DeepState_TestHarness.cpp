...
TEST(smam_deepstate_test,vp01_test){
  ...
  std::string vw_t = "/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/vp01/AFL_vp01/afl_inputs/" + std::to_string(t) + "_vw.qs";
  qs::c_qsave(vw,vw_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "vw values: "<< vw << std::endl;
  NumericVector t(1);
  t[0]  = RcppDeepState_double();
  std::string t_t = "/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/vp01/AFL_vp01/afl_inputs/" + std::to_string(t) + "_t.qs";
  qs::c_qsave(t,t_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "t values: "<< t << std::endl;
  NumericVector lambda1(1);
  lambda1[0]  = RcppDeepState_double();
  std::string lambda1_t = "/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/vp01/AFL_vp01/afl_inputs/" + std::to_string(t) + "_lambda1.qs";
  ...
  std::string lambda0_t = "/home/akhila/fuzzer_packages/fuzzedpackages/smam/inst/testfiles/vp01/AFL_vp01/afl_inputs/" + std::to_string(t) + "_lambda0.qs";
