...
TEST(sf_deepstate_test,CPL_gdalinfo_test){
  ...
  std::string obj_t = "/home/akhila/fuzzer_packages/fuzzedpackages/sf/inst/testfiles/CPL_gdalinfo/AFL_CPL_gdalinfo/afl_inputs/" + std::to_string(t) + "_obj.qs";
  qs::c_qsave(obj,obj_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "obj values: "<< obj << std::endl;
  CharacterVector options  = RcppDeepState_CharacterVector();
  std::string options_t = "/home/akhila/fuzzer_packages/fuzzedpackages/sf/inst/testfiles/CPL_gdalinfo/AFL_CPL_gdalinfo/afl_inputs/" + std::to_string(t) + "_options.qs";
  qs::c_qsave(options,options_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "options values: "<< options << std::endl;
  CharacterVector oo  = RcppDeepState_CharacterVector();
  std::string oo_t = "/home/akhila/fuzzer_packages/fuzzedpackages/sf/inst/testfiles/CPL_gdalinfo/AFL_CPL_gdalinfo/afl_inputs/" + std::to_string(t) + "_oo.qs";
  qs::c_qsave(oo,oo_t,
		"high", "zstd", 1, 15, true, 1);
