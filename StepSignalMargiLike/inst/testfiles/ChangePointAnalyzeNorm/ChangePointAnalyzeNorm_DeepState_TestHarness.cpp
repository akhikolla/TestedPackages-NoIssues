...
TEST(StepSignalMargiLike_deepstate_test,ChangePointAnalyzeNorm_test){
  ...
  qs::c_qsave(Data,"/home/akhila/fuzzer_packages/fuzzedpackages/StepSignalMargiLike/inst/testfiles/ChangePointAnalyzeNorm/inputs/Data.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Data values: "<< Data << std::endl;
  IntegerVector InputLength  = RcppDeepState_IntegerVector();
  qs::c_qsave(InputLength,"/home/akhila/fuzzer_packages/fuzzedpackages/StepSignalMargiLike/inst/testfiles/ChangePointAnalyzeNorm/inputs/InputLength.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "InputLength values: "<< InputLength << std::endl;
  IntegerVector MaxJump  = RcppDeepState_IntegerVector();
  qs::c_qsave(MaxJump,"/home/akhila/fuzzer_packages/fuzzedpackages/StepSignalMargiLike/inst/testfiles/ChangePointAnalyzeNorm/inputs/MaxJump.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "MaxJump values: "<< MaxJump << std::endl;
  NumericVector Prior  = RcppDeepState_NumericVector();
  qs::c_qsave(Prior,"/home/akhila/fuzzer_packages/fuzzedpackages/StepSignalMargiLike/inst/testfiles/ChangePointAnalyzeNorm/inputs/Prior.qs",
		"high", "zstd", 1, 15, true, 1);
