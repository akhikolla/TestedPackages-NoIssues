...
mySqlToIp4 <- function(x) {
    .Call('_Rip46_mySqlToIp4', PACKAGE = 'Rip46', x)
}

hostToIp4 <- function(x) {
    .Call('_Rip46_hostToIp4', PACKAGE = 'Rip46', x)
}

ip4ToHost <- function(x) {
    .Call('_Rip46_ip4ToHost', PACKAGE = 'Rip46', x)
}
...
#' @export
mask <- function(x, m) {
    .Call('_Rip46_mask', PACKAGE = 'Rip46', x, m)
}

#' @rdname network-mask
#' @export
classA <- function(x) {
    .Call('_Rip46_classA', PACKAGE = 'Rip46', x)
}

#' @rdname network-mask 
#' @export
classB <- function(x) {
    .Call('_Rip46_classB', PACKAGE = 'Rip46', x)
}

#' @rdname network-mask
#' @export
classC <- function(x) {
    .Call('_Rip46_classC', PACKAGE = 'Rip46', x)
}

hostToIp6 <- function(x) {
    .Call('_Rip46_hostToIp6', PACKAGE = 'Rip46', x)
}

ip6ToHost <- function(x) {
    .Call('_Rip46_ip6ToHost', PACKAGE = 'Rip46', x)
}
