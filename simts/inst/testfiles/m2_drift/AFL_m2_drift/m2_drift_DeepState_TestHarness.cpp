...
TEST(simts_deepstate_test,m2_drift_test){
  ...
  std::string omega_t = "/home/akhila/fuzzer_packages/fuzzedpackages/simts/inst/testfiles/m2_drift/AFL_m2_drift/afl_inputs/" + std::to_string(t) + "_omega.qs";
  qs::c_qsave(omega,omega_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "omega values: "<< omega << std::endl;
  IntegerVector n_ts(1);
  n_ts[0]  = RcppDeepState_int();
  std::string n_ts_t = "/home/akhila/fuzzer_packages/fuzzedpackages/simts/inst/testfiles/m2_drift/AFL_m2_drift/afl_inputs/" + std::to_string(t) + "_n_ts.qs";
