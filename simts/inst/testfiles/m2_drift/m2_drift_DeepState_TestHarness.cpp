...
TEST(simts_deepstate_test,m2_drift_test){
  ...
  qs::c_qsave(omega,"/home/akhila/fuzzer_packages/fuzzedpackages/simts/inst/testfiles/m2_drift/inputs/omega.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "omega values: "<< omega << std::endl;
  IntegerVector n_ts(1);
  n_ts[0]  = RcppDeepState_int();
  qs::c_qsave(n_ts,"/home/akhila/fuzzer_packages/fuzzedpackages/simts/inst/testfiles/m2_drift/inputs/n_ts.qs",
		"high", "zstd", 1, 15, true, 1);
