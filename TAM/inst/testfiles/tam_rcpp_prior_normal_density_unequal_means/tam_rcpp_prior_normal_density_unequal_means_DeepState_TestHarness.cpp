...
TEST(TAM_deepstate_test,tam_rcpp_prior_normal_density_unequal_means_test){
  ...
  qs::c_qsave(theta,"/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_prior_normal_density_unequal_means/inputs/theta.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "theta values: "<< theta << std::endl;
  NumericMatrix mu  = RcppDeepState_NumericMatrix();
  qs::c_qsave(mu,"/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_prior_normal_density_unequal_means/inputs/mu.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mu values: "<< mu << std::endl;
  NumericMatrix varInverse  = RcppDeepState_NumericMatrix();
  qs::c_qsave(varInverse,"/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_prior_normal_density_unequal_means/inputs/varInverse.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "varInverse values: "<< varInverse << std::endl;
  NumericVector COEFF  = RcppDeepState_NumericVector();
  qs::c_qsave(COEFF,"/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_prior_normal_density_unequal_means/inputs/COEFF.qs",
		"high", "zstd", 1, 15, true, 1);
