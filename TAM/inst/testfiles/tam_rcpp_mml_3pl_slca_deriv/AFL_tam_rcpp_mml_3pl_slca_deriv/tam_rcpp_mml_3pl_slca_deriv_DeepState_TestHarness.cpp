...
TEST(TAM_deepstate_test,tam_rcpp_mml_3pl_slca_deriv_test){
  ...
  std::string XdesM_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_mml_3pl_slca_deriv/AFL_tam_rcpp_mml_3pl_slca_deriv/afl_inputs/" + std::to_string(t) + "_XdesM.qs";
  qs::c_qsave(XdesM,XdesM_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "XdesM values: "<< XdesM << std::endl;
  NumericVector dimXdes  = RcppDeepState_NumericVector();
  std::string dimXdes_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_mml_3pl_slca_deriv/AFL_tam_rcpp_mml_3pl_slca_deriv/afl_inputs/" + std::to_string(t) + "_dimXdes.qs";
  qs::c_qsave(dimXdes,dimXdes_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dimXdes values: "<< dimXdes << std::endl;
  NumericVector Xlambda  = RcppDeepState_NumericVector();
  std::string Xlambda_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_mml_3pl_slca_deriv/AFL_tam_rcpp_mml_3pl_slca_deriv/afl_inputs/" + std::to_string(t) + "_Xlambda.qs";
  qs::c_qsave(Xlambda,Xlambda_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Xlambda values: "<< Xlambda << std::endl;
  NumericVector probs  = RcppDeepState_NumericVector();
  std::string probs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_mml_3pl_slca_deriv/AFL_tam_rcpp_mml_3pl_slca_deriv/afl_inputs/" + std::to_string(t) + "_probs.qs";
  qs::c_qsave(probs,probs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "probs values: "<< probs << std::endl;
  NumericVector nik  = RcppDeepState_NumericVector();
  std::string nik_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_mml_3pl_slca_deriv/AFL_tam_rcpp_mml_3pl_slca_deriv/afl_inputs/" + std::to_string(t) + "_nik.qs";
  ...
  std::string guess_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_mml_3pl_slca_deriv/AFL_tam_rcpp_mml_3pl_slca_deriv/afl_inputs/" + std::to_string(t) + "_guess.qs";
  qs::c_qsave(guess,guess_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "guess values: "<< guess << std::endl;
  NumericVector probs0  = RcppDeepState_NumericVector();
  std::string probs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_mml_3pl_slca_deriv/AFL_tam_rcpp_mml_3pl_slca_deriv/afl_inputs/" + std::to_string(t) + "_probs.qs";
  std::string probs0_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_mml_3pl_slca_deriv/AFL_tam_rcpp_mml_3pl_slca_deriv/afl_inputs/" + std::to_string(t) + "_probs0.qs";
