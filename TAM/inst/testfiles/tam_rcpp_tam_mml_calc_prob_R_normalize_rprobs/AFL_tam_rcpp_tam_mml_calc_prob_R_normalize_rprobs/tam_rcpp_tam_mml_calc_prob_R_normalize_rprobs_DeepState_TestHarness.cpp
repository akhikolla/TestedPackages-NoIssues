...
TEST(TAM_deepstate_test,tam_rcpp_tam_mml_calc_prob_R_normalize_rprobs_test){
  ...
  std::string rr_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_tam_mml_calc_prob_R_normalize_rprobs/AFL_tam_rcpp_tam_mml_calc_prob_R_normalize_rprobs/afl_inputs/" + std::to_string(t) + "_rr.qs";
  qs::c_qsave(rr,rr_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "rr values: "<< rr << std::endl;
  IntegerVector dim_rr  = RcppDeepState_IntegerVector();
  std::string dim_rr_t = "/home/akhila/fuzzer_packages/fuzzedpackages/TAM/inst/testfiles/tam_rcpp_tam_mml_calc_prob_R_normalize_rprobs/AFL_tam_rcpp_tam_mml_calc_prob_R_normalize_rprobs/afl_inputs/" + std::to_string(t) + "_dim_rr.qs";
