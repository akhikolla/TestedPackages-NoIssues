...
TEST(wicket_deepstate_test,bounding_wkt_points_test){
  ...
  std::string min_x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/wicket/inst/testfiles/bounding_wkt_points/libFuzzer_bounding_wkt_points/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_min_x.qs";
  qs::c_qsave(min_x,min_x_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "min_x values: "<< min_x << std::endl;
  NumericVector max_x  = RcppDeepState_NumericVector();
  std::string max_x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/wicket/inst/testfiles/bounding_wkt_points/libFuzzer_bounding_wkt_points/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_max_x.qs";
  qs::c_qsave(max_x,max_x_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "max_x values: "<< max_x << std::endl;
  NumericVector min_y  = RcppDeepState_NumericVector();
  std::string min_y_t = "/home/akhila/fuzzer_packages/fuzzedpackages/wicket/inst/testfiles/bounding_wkt_points/libFuzzer_bounding_wkt_points/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_min_y.qs";
  qs::c_qsave(min_y,min_y_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "min_y values: "<< min_y << std::endl;
  NumericVector max_y  = RcppDeepState_NumericVector();
  std::string max_y_t = "/home/akhila/fuzzer_packages/fuzzedpackages/wicket/inst/testfiles/bounding_wkt_points/libFuzzer_bounding_wkt_points/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_max_y.qs";
