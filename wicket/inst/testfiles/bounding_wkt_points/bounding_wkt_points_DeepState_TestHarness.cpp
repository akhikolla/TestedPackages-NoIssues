...
TEST(wicket_deepstate_test,bounding_wkt_points_test){
  ...
  qs::c_qsave(min_x,"/home/akhila/fuzzer_packages/fuzzedpackages/wicket/inst/testfiles/bounding_wkt_points/inputs/min_x.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "min_x values: "<< min_x << std::endl;
  NumericVector max_x  = RcppDeepState_NumericVector();
  qs::c_qsave(max_x,"/home/akhila/fuzzer_packages/fuzzedpackages/wicket/inst/testfiles/bounding_wkt_points/inputs/max_x.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "max_x values: "<< max_x << std::endl;
  NumericVector min_y  = RcppDeepState_NumericVector();
  qs::c_qsave(min_y,"/home/akhila/fuzzer_packages/fuzzedpackages/wicket/inst/testfiles/bounding_wkt_points/inputs/min_y.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "min_y values: "<< min_y << std::endl;
  NumericVector max_y  = RcppDeepState_NumericVector();
  qs::c_qsave(max_y,"/home/akhila/fuzzer_packages/fuzzedpackages/wicket/inst/testfiles/bounding_wkt_points/inputs/max_y.qs",
		"high", "zstd", 1, 15, true, 1);
