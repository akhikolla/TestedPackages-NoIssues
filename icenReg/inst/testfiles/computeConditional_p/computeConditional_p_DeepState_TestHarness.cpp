...
TEST(icenReg_deepstate_test,computeConditional_p_test){
  ...
  qs::c_qsave(q,"/home/akhila/fuzzer_packages/fuzzedpackages/icenReg/inst/testfiles/computeConditional_p/inputs/q.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "q values: "<< q << std::endl;
  NumericVector etas  = RcppDeepState_NumericVector();
  qs::c_qsave(etas,"/home/akhila/fuzzer_packages/fuzzedpackages/icenReg/inst/testfiles/computeConditional_p/inputs/etas.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "etas values: "<< etas << std::endl;
  NumericMatrix baselineParams  = RcppDeepState_NumericMatrix();
  qs::c_qsave(baselineParams,"/home/akhila/fuzzer_packages/fuzzedpackages/icenReg/inst/testfiles/computeConditional_p/inputs/baselineParams.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "baselineParams values: "<< baselineParams << std::endl;
  CharacterVector reg_model  = RcppDeepState_CharacterVector();
  qs::c_qsave(reg_model,"/home/akhila/fuzzer_packages/fuzzedpackages/icenReg/inst/testfiles/computeConditional_p/inputs/reg_model.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "reg_model values: "<< reg_model << std::endl;
  CharacterVector base_dist  = RcppDeepState_CharacterVector();
  qs::c_qsave(base_dist,"/home/akhila/fuzzer_packages/fuzzedpackages/icenReg/inst/testfiles/computeConditional_p/inputs/base_dist.qs",
		"high", "zstd", 1, 15, true, 1);
