...
TEST(icenReg_deepstate_test,computeConditional_q_test){
  ...
  std::string p_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icenReg/inst/testfiles/computeConditional_q/libFuzzer_computeConditional_q/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_p.qs";
  qs::c_qsave(p,p_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "p values: "<< p << std::endl;
  NumericVector etas  = RcppDeepState_NumericVector();
  std::string etas_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icenReg/inst/testfiles/computeConditional_q/libFuzzer_computeConditional_q/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_etas.qs";
  qs::c_qsave(etas,etas_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "etas values: "<< etas << std::endl;
  NumericMatrix baselineParams  = RcppDeepState_NumericMatrix();
  std::string baselineParams_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icenReg/inst/testfiles/computeConditional_q/libFuzzer_computeConditional_q/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_baselineParams.qs";
  ...
  std::string reg_model_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icenReg/inst/testfiles/computeConditional_q/libFuzzer_computeConditional_q/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_reg_model.qs";
  ...
  std::string base_dist_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icenReg/inst/testfiles/computeConditional_q/libFuzzer_computeConditional_q/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_base_dist.qs";
