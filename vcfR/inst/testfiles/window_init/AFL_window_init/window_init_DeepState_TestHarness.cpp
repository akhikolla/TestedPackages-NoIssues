...
TEST(vcfR_deepstate_test,window_init_test){
  ...
  std::string window_size_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vcfR/inst/testfiles/window_init/AFL_window_init/afl_inputs/" + std::to_string(t) + "_window_size.qs";
  ...
  std::string max_bp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vcfR/inst/testfiles/window_init/AFL_window_init/afl_inputs/" + std::to_string(t) + "_max_bp.qs";
