...
TEST(compas_deepstate_test,calCo_test){
  ...
  std::string prev_atoms_t = "/home/akhila/fuzzer_packages/fuzzedpackages/compas/inst/testfiles/calCo/AFL_calCo/afl_inputs/" + std::to_string(t) + "_prev_atoms.qs";
  ...
  std::string length_t = "/home/akhila/fuzzer_packages/fuzzedpackages/compas/inst/testfiles/calCo/AFL_calCo/afl_inputs/" + std::to_string(t) + "_length.qs";
  qs::c_qsave(length,length_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "length values: "<< length << std::endl;
  NumericVector bAngle(1);
  bAngle[0]  = RcppDeepState_double();
  std::string bAngle_t = "/home/akhila/fuzzer_packages/fuzzedpackages/compas/inst/testfiles/calCo/AFL_calCo/afl_inputs/" + std::to_string(t) + "_bAngle.qs";
  qs::c_qsave(bAngle,bAngle_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "bAngle values: "<< bAngle << std::endl;
  NumericVector tAngle(1);
  tAngle[0]  = RcppDeepState_double();
  std::string tAngle_t = "/home/akhila/fuzzer_packages/fuzzedpackages/compas/inst/testfiles/calCo/AFL_calCo/afl_inputs/" + std::to_string(t) + "_tAngle.qs";
