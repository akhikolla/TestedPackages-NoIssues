...
TEST(Rpvt_deepstate_test,BO_AL_MARHOUN_test){
  ...
  qs::c_qsave(t,"/home/akhila/fuzzer_packages/fuzzedpackages/Rpvt/inst/testfiles/BO_AL_MARHOUN/inputs/t.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "t values: "<< t << std::endl;
  NumericVector p(1);
  p[0]  = RcppDeepState_double();
  qs::c_qsave(p,"/home/akhila/fuzzer_packages/fuzzedpackages/Rpvt/inst/testfiles/BO_AL_MARHOUN/inputs/p.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "p values: "<< p << std::endl;
  NumericVector api(1);
  api[0]  = RcppDeepState_double();
  qs::c_qsave(api,"/home/akhila/fuzzer_packages/fuzzedpackages/Rpvt/inst/testfiles/BO_AL_MARHOUN/inputs/api.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "api values: "<< api << std::endl;
  NumericVector spgr(1);
  spgr[0]  = RcppDeepState_double();
  qs::c_qsave(spgr,"/home/akhila/fuzzer_packages/fuzzedpackages/Rpvt/inst/testfiles/BO_AL_MARHOUN/inputs/spgr.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "spgr values: "<< spgr << std::endl;
  NumericVector rsi(1);
  rsi[0]  = RcppDeepState_double();
  qs::c_qsave(rsi,"/home/akhila/fuzzer_packages/fuzzedpackages/Rpvt/inst/testfiles/BO_AL_MARHOUN/inputs/rsi.qs",
		"high", "zstd", 1, 15, true, 1);
