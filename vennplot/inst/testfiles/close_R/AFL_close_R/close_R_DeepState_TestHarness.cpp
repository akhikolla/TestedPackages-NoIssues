...
TEST(vennplot_deepstate_test,close_R_test){
  ...
  std::string xy1_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vennplot/inst/testfiles/close_R/AFL_close_R/afl_inputs/" + std::to_string(t) + "_xy1.qs";
  qs::c_qsave(xy1,xy1_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "xy1 values: "<< xy1 << std::endl;
  NumericMatrix xy2  = RcppDeepState_NumericMatrix();
  std::string xy2_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vennplot/inst/testfiles/close_R/AFL_close_R/afl_inputs/" + std::to_string(t) + "_xy2.qs";
  qs::c_qsave(xy2,xy2_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "xy2 values: "<< xy2 << std::endl;
  NumericVector radius1  = RcppDeepState_NumericVector();
  std::string radius1_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vennplot/inst/testfiles/close_R/AFL_close_R/afl_inputs/" + std::to_string(t) + "_radius1.qs";
  qs::c_qsave(radius1,radius1_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "radius1 values: "<< radius1 << std::endl;
  NumericVector radius2  = RcppDeepState_NumericVector();
  std::string radius2_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vennplot/inst/testfiles/close_R/AFL_close_R/afl_inputs/" + std::to_string(t) + "_radius2.qs";
  qs::c_qsave(radius2,radius2_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "radius2 values: "<< radius2 << std::endl;
  NumericVector delta(1);
  delta[0]  = RcppDeepState_double();
  std::string delta_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vennplot/inst/testfiles/close_R/AFL_close_R/afl_inputs/" + std::to_string(t) + "_delta.qs";
  qs::c_qsave(delta,delta_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "delta values: "<< delta << std::endl;
  NumericVector direc  = RcppDeepState_NumericVector();
  std::string direc_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vennplot/inst/testfiles/close_R/AFL_close_R/afl_inputs/" + std::to_string(t) + "_direc.qs";
