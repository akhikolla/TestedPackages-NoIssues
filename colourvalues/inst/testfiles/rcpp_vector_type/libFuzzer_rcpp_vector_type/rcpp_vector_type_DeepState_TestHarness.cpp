...
TEST(colourvalues_deepstate_test,rcpp_vector_type_test){
  ...
  std::string new_type_t = "/home/akhila/fuzzer_packages/fuzzedpackages/colourvalues/inst/testfiles/rcpp_vector_type/libFuzzer_rcpp_vector_type/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_new_type.qs";
  ...
  std::string existing_type_t = "/home/akhila/fuzzer_packages/fuzzedpackages/colourvalues/inst/testfiles/rcpp_vector_type/libFuzzer_rcpp_vector_type/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_existing_type.qs";
