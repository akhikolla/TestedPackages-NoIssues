...
Wbal_ <- function(t, P, CP) {
    .Call('_cycleRtools_Wbal_', PACKAGE = 'cycleRtools', t, P, CP)
}
...
diff_section <- function(x, br) {
    .Call('_cycleRtools_diff_section', PACKAGE = 'cycleRtools', x, br)
}

Diff <- function(x) {
    .Call('_cycleRtools_Diff', PACKAGE = 'cycleRtools', x)
}
...
mmv2 <- function(x, windows) {
    .Call('_cycleRtools_mmv2', PACKAGE = 'cycleRtools', x, windows)
}

na_split <- function(x) {
    .Call('_cycleRtools_na_split', PACKAGE = 'cycleRtools', x)
}

ema_weights <- function(len) {
    .Call('_cycleRtools_ema_weights', PACKAGE = 'cycleRtools', len)
}

mean_weights <- function(len) {
    .Call('_cycleRtools_mean_weights', PACKAGE = 'cycleRtools', len)
}

#' @rdname rollmean_smth
#' @export
rollmean_ <- function(x, window, ema, narm) {
    .Call('_cycleRtools_rollmean_', PACKAGE = 'cycleRtools', x, window, ema, narm)
}
...
rollmean_nunif <- function(x, t, window) {
    .Call('_cycleRtools_rollmean_nunif', PACKAGE = 'cycleRtools', x, t, window)
}

zone_index_ <- function(x, zb) {
    .Call('_cycleRtools_zone_index_', PACKAGE = 'cycleRtools', x, zb)
}
