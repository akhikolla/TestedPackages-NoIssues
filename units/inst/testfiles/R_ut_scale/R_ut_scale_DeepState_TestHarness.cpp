...
TEST(units_deepstate_test,R_ut_scale_test){
  ...
  qs::c_qsave(nw,"/home/akhila/fuzzer_packages/fuzzedpackages/units/inst/testfiles/R_ut_scale/inputs/nw.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nw values: "<< nw << std::endl;
  CharacterVector old  = RcppDeepState_CharacterVector();
  qs::c_qsave(old,"/home/akhila/fuzzer_packages/fuzzedpackages/units/inst/testfiles/R_ut_scale/inputs/old.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "old values: "<< old << std::endl;
  NumericVector d  = RcppDeepState_NumericVector();
  qs::c_qsave(d,"/home/akhila/fuzzer_packages/fuzzedpackages/units/inst/testfiles/R_ut_scale/inputs/d.qs",
		"high", "zstd", 1, 15, true, 1);
