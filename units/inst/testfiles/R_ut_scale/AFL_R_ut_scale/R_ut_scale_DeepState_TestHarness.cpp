...
TEST(units_deepstate_test,R_ut_scale_test){
  ...
  std::string nw_t = "/home/akhila/fuzzer_packages/fuzzedpackages/units/inst/testfiles/R_ut_scale/AFL_R_ut_scale/afl_inputs/" + std::to_string(t) + "_nw.qs";
  qs::c_qsave(nw,nw_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nw values: "<< nw << std::endl;
  CharacterVector old  = RcppDeepState_CharacterVector();
  std::string old_t = "/home/akhila/fuzzer_packages/fuzzedpackages/units/inst/testfiles/R_ut_scale/AFL_R_ut_scale/afl_inputs/" + std::to_string(t) + "_old.qs";
  qs::c_qsave(old,old_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "old values: "<< old << std::endl;
  NumericVector d  = RcppDeepState_NumericVector();
  std::string d_t = "/home/akhila/fuzzer_packages/fuzzedpackages/units/inst/testfiles/R_ut_scale/AFL_R_ut_scale/afl_inputs/" + std::to_string(t) + "_d.qs";
  qs::c_qsave(d,d_t,
		"high", "zstd", 1, 15, true, 1);
