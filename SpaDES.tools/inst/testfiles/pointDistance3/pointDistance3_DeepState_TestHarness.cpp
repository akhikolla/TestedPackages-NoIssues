...
TEST(SpaDES.tools_deepstate_test,pointDistance3_test){
  ...
  qs::c_qsave(fromX,"/home/akhila/fuzzer_packages/fuzzedpackages/SpaDES.tools/inst/testfiles/pointDistance3/inputs/fromX.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "fromX values: "<< fromX << std::endl;
  NumericVector toX  = RcppDeepState_NumericVector();
  qs::c_qsave(toX,"/home/akhila/fuzzer_packages/fuzzedpackages/SpaDES.tools/inst/testfiles/pointDistance3/inputs/toX.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "toX values: "<< toX << std::endl;
  NumericVector fromY  = RcppDeepState_NumericVector();
  qs::c_qsave(fromY,"/home/akhila/fuzzer_packages/fuzzedpackages/SpaDES.tools/inst/testfiles/pointDistance3/inputs/fromY.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "fromY values: "<< fromY << std::endl;
  NumericVector toY  = RcppDeepState_NumericVector();
  qs::c_qsave(toY,"/home/akhila/fuzzer_packages/fuzzedpackages/SpaDES.tools/inst/testfiles/pointDistance3/inputs/toY.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "toY values: "<< toY << std::endl;
  NumericVector maxDistance(1);
  maxDistance[0]  = RcppDeepState_double();
  qs::c_qsave(maxDistance,"/home/akhila/fuzzer_packages/fuzzedpackages/SpaDES.tools/inst/testfiles/pointDistance3/inputs/maxDistance.qs",
		"high", "zstd", 1, 15, true, 1);
