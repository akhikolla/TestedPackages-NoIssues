...
TEST(SpaDES.tools_deepstate_test,pointDistance3_test){
  ...
  std::string fromX_t = "/home/akhila/fuzzer_packages/fuzzedpackages/SpaDES.tools/inst/testfiles/pointDistance3/AFL_pointDistance3/afl_inputs/" + std::to_string(t) + "_fromX.qs";
  qs::c_qsave(fromX,fromX_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "fromX values: "<< fromX << std::endl;
  NumericVector toX  = RcppDeepState_NumericVector();
  std::string toX_t = "/home/akhila/fuzzer_packages/fuzzedpackages/SpaDES.tools/inst/testfiles/pointDistance3/AFL_pointDistance3/afl_inputs/" + std::to_string(t) + "_toX.qs";
  qs::c_qsave(toX,toX_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "toX values: "<< toX << std::endl;
  NumericVector fromY  = RcppDeepState_NumericVector();
  std::string fromY_t = "/home/akhila/fuzzer_packages/fuzzedpackages/SpaDES.tools/inst/testfiles/pointDistance3/AFL_pointDistance3/afl_inputs/" + std::to_string(t) + "_fromY.qs";
  qs::c_qsave(fromY,fromY_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "fromY values: "<< fromY << std::endl;
  NumericVector toY  = RcppDeepState_NumericVector();
  std::string toY_t = "/home/akhila/fuzzer_packages/fuzzedpackages/SpaDES.tools/inst/testfiles/pointDistance3/AFL_pointDistance3/afl_inputs/" + std::to_string(t) + "_toY.qs";
  qs::c_qsave(toY,toY_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "toY values: "<< toY << std::endl;
  NumericVector maxDistance(1);
  maxDistance[0]  = RcppDeepState_double();
  std::string maxDistance_t = "/home/akhila/fuzzer_packages/fuzzedpackages/SpaDES.tools/inst/testfiles/pointDistance3/AFL_pointDistance3/afl_inputs/" + std::to_string(t) + "_maxDistance.qs";
