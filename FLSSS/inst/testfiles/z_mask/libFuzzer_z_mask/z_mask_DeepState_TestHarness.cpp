...
TEST(FLSSS_deepstate_test,z_mask_test){
  ...
  std::string which64int_t = "/home/akhila/fuzzer_packages/fuzzedpackages/FLSSS/inst/testfiles/z_mask/libFuzzer_z_mask/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_which64int.qs";
  ...
  std::string bitSize_t = "/home/akhila/fuzzer_packages/fuzzedpackages/FLSSS/inst/testfiles/z_mask/libFuzzer_z_mask/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_bitSize.qs";
