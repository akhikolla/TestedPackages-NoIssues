...
TEST(heuristicsmineR_deepstate_test,count_parallel_lifecycle_test){
  ...
  qs::c_qsave(cases,"/home/akhila/fuzzer_packages/fuzzedpackages/heuristicsmineR/inst/testfiles/count_parallel_lifecycle/inputs/cases.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "cases values: "<< cases << std::endl;
  IntegerVector activities  = RcppDeepState_IntegerVector();
  qs::c_qsave(activities,"/home/akhila/fuzzer_packages/fuzzedpackages/heuristicsmineR/inst/testfiles/count_parallel_lifecycle/inputs/activities.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "activities values: "<< activities << std::endl;
  IntegerVector lifecycle  = RcppDeepState_IntegerVector();
  qs::c_qsave(lifecycle,"/home/akhila/fuzzer_packages/fuzzedpackages/heuristicsmineR/inst/testfiles/count_parallel_lifecycle/inputs/lifecycle.qs",
		"high", "zstd", 1, 15, true, 1);
