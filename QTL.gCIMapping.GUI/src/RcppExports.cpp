...
RcppExport SEXP _QTL_gCIMapping_GUI_markerinsert(SEXP mpSEXP, SEXP genoSEXP, SEXP mapSEXP, SEXP clSEXP, SEXP gg1SEXP, SEXP gg2SEXP, SEXP gg0SEXP, SEXP flagRILSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_QTL_gCIMapping_GUI_markerinsert", (DL_FUNC) &_QTL_gCIMapping_GUI_markerinsert, 8},
    {NULL, NULL, 0}
};

RcppExport void R_init_QTL_gCIMapping_GUI(DllInfo *dll) {
