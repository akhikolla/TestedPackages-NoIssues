...
TEST(Bioi_deepstate_test,find_min_dists_cpp_test){
  ...
  std::string mOne_t = "/home/akhila/fuzzer_packages/fuzzedpackages/Bioi/inst/testfiles/find_min_dists_cpp/AFL_find_min_dists_cpp/afl_inputs/" + std::to_string(t) + "_mOne.qs";
  qs::c_qsave(mOne,mOne_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mOne values: "<< mOne << std::endl;
  NumericMatrix mTwo  = RcppDeepState_NumericMatrix();
  std::string mTwo_t = "/home/akhila/fuzzer_packages/fuzzedpackages/Bioi/inst/testfiles/find_min_dists_cpp/AFL_find_min_dists_cpp/afl_inputs/" + std::to_string(t) + "_mTwo.qs";
