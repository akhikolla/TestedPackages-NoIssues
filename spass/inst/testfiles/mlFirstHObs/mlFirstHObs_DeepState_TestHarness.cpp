...
TEST(spass_deepstate_test,mlFirstHObs_test){
  ...
  qs::c_qsave(y,"/home/akhila/fuzzer_packages/fuzzedpackages/spass/inst/testfiles/mlFirstHObs/inputs/y.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "y values: "<< y << std::endl;
  NumericMatrix groupE  = RcppDeepState_NumericMatrix();
  qs::c_qsave(groupE,"/home/akhila/fuzzer_packages/fuzzedpackages/spass/inst/testfiles/mlFirstHObs/inputs/groupE.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "groupE values: "<< groupE << std::endl;
  NumericMatrix groupC  = RcppDeepState_NumericMatrix();
  qs::c_qsave(groupC,"/home/akhila/fuzzer_packages/fuzzedpackages/spass/inst/testfiles/mlFirstHObs/inputs/groupC.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "groupC values: "<< groupC << std::endl;
  IntegerVector nE(1);
  nE[0]  = RcppDeepState_int();
  qs::c_qsave(nE,"/home/akhila/fuzzer_packages/fuzzedpackages/spass/inst/testfiles/mlFirstHObs/inputs/nE.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nE values: "<< nE << std::endl;
  IntegerVector nC(1);
  nC[0]  = RcppDeepState_int();
  qs::c_qsave(nC,"/home/akhila/fuzzer_packages/fuzzedpackages/spass/inst/testfiles/mlFirstHObs/inputs/nC.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nC values: "<< nC << std::endl;
  NumericVector tpE  = RcppDeepState_NumericVector();
  qs::c_qsave(tpE,"/home/akhila/fuzzer_packages/fuzzedpackages/spass/inst/testfiles/mlFirstHObs/inputs/tpE.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "tpE values: "<< tpE << std::endl;
  NumericVector tpC  = RcppDeepState_NumericVector();
  qs::c_qsave(tpC,"/home/akhila/fuzzer_packages/fuzzedpackages/spass/inst/testfiles/mlFirstHObs/inputs/tpC.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "tpC values: "<< tpC << std::endl;
  IntegerVector type(1);
  type[0]  = RcppDeepState_int();
  qs::c_qsave(type,"/home/akhila/fuzzer_packages/fuzzedpackages/spass/inst/testfiles/mlFirstHObs/inputs/type.qs",
		"high", "zstd", 1, 15, true, 1);
