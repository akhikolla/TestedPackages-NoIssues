...
TEST(srm_deepstate_test,SRM_RCPP_SIGMA_Y_INV_WOODBURY_PHI_INV_test){
  ...
  qs::c_qsave(SIGMA_U_INV,"/home/akhila/fuzzer_packages/fuzzedpackages/srm/inst/testfiles/SRM_RCPP_SIGMA_Y_INV_WOODBURY_PHI_INV/inputs/SIGMA_U_INV.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "SIGMA_U_INV values: "<< SIGMA_U_INV << std::endl;
  IntegerVector NI(1);
  NI[0]  = RcppDeepState_int();
  qs::c_qsave(NI,"/home/akhila/fuzzer_packages/fuzzedpackages/srm/inst/testfiles/SRM_RCPP_SIGMA_Y_INV_WOODBURY_PHI_INV/inputs/NI.qs",
		"high", "zstd", 1, 15, true, 1);
