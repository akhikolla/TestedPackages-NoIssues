...
IDHeatwavesCPP <- function(heatwaveLength, tempsExceedingCutoff) {
    .Call('_futureheatwaves_IDHeatwavesCPP', PACKAGE = 'futureheatwaves', heatwaveLength, tempsExceedingCutoff)
}
...
storeHeatwaveEntry <- function(index, hwSize, hwCounter, hw, hwNumber) {
    invisible(.Call('_futureheatwaves_storeHeatwaveEntry', PACKAGE = 'futureheatwaves', index, hwSize, hwCounter, hw, hwNumber))
}
...
storeZeroes <- function(index, potentialHeatwave, hw, hwNumber) {
    invisible(.Call('_futureheatwaves_storeZeroes', PACKAGE = 'futureheatwaves', index, potentialHeatwave, hw, hwNumber))
}

# Register entry points for exported C++ functions
methods::setLoadAction(function(ns) {
    .Call('_futureheatwaves_RcppExport_registerCCallable', PACKAGE = 'futureheatwaves')
})
