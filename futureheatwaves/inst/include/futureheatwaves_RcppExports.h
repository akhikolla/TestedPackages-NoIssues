...
namespace futureheatwaves {
    ...
    namespace {
        void validateSignature(const char* sig) {
            ...
            static Ptr_validate p_validate = (Ptr_validate)
                R_GetCCallable("futureheatwaves", "_futureheatwaves_RcppExport_validate");
            if (!p_validate(sig)) {
    ...
    inline Rcpp::DataFrame IDHeatwavesCPP(int heatwaveLength, Rcpp::NumericVector tempsExceedingCutoff) {
        ...
        if (p_IDHeatwavesCPP == NULL) {
            ...
            p_IDHeatwavesCPP = (Ptr_IDHeatwavesCPP)R_GetCCallable("futureheatwaves", "_futureheatwaves_IDHeatwavesCPP");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_IDHeatwavesCPP(Shield<SEXP>(Rcpp::wrap(heatwaveLength)), Shield<SEXP>(Rcpp::wrap(tempsExceedingCutoff)));
        }
    ...
    inline void storeHeatwaveEntry(int index, int hwSize, int hwCounter, std::vector<int>& hw, std::vector<int>& hwNumber) {
        ...
        if (p_storeHeatwaveEntry == NULL) {
            ...
            p_storeHeatwaveEntry = (Ptr_storeHeatwaveEntry)R_GetCCallable("futureheatwaves", "_futureheatwaves_storeHeatwaveEntry");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_storeHeatwaveEntry(Shield<SEXP>(Rcpp::wrap(index)), Shield<SEXP>(Rcpp::wrap(hwSize)), Shield<SEXP>(Rcpp::wrap(hwCounter)), Shield<SEXP>(Rcpp::wrap(hw)), Shield<SEXP>(Rcpp::wrap(hwNumber)));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (Rcpp::internal::isLongjumpSentinel(rcpp_result_gen))
    ...
    inline void storeZeroes(int index, int potentialHeatwave, std::vector<int>& hw, std::vector<int>& hwNumber) {
        ...
        if (p_storeZeroes == NULL) {
            ...
            p_storeZeroes = (Ptr_storeZeroes)R_GetCCallable("futureheatwaves", "_futureheatwaves_storeZeroes");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_storeZeroes(Shield<SEXP>(Rcpp::wrap(index)), Shield<SEXP>(Rcpp::wrap(potentialHeatwave)), Shield<SEXP>(Rcpp::wrap(hw)), Shield<SEXP>(Rcpp::wrap(hwNumber)));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (Rcpp::internal::isLongjumpSentinel(rcpp_result_gen))
