...
TEST(ClusVis_deepstate_test,computeGradientCPP_test){
  ...
  std::string Rparam_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ClusVis/inst/testfiles/computeGradientCPP/libFuzzer_computeGradientCPP/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_Rparam.qs";
  qs::c_qsave(Rparam,Rparam_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Rparam values: "<< Rparam << std::endl;
  NumericVector Rprop  = RcppDeepState_NumericVector();
  std::string Rprop_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ClusVis/inst/testfiles/computeGradientCPP/libFuzzer_computeGradientCPP/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_Rprop.qs";
  qs::c_qsave(Rprop,Rprop_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Rprop values: "<< Rprop << std::endl;
  NumericMatrix Rlogu  = RcppDeepState_NumericMatrix();
  std::string Rlogu_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ClusVis/inst/testfiles/computeGradientCPP/libFuzzer_computeGradientCPP/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_Rlogu.qs";
  qs::c_qsave(Rlogu,Rlogu_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Rlogu values: "<< Rlogu << std::endl;
  NumericMatrix Rtik  = RcppDeepState_NumericMatrix();
  std::string Rtik_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ClusVis/inst/testfiles/computeGradientCPP/libFuzzer_computeGradientCPP/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_Rtik.qs";
