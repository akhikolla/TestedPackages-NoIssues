...
TEST(sirus_deepstate_test,numSmaller_test){
  ...
  qs::c_qsave(values,"/home/akhila/fuzzer_packages/fuzzedpackages/sirus/inst/testfiles/numSmaller/inputs/values.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "values values: "<< values << std::endl;
  NumericVector reference  = RcppDeepState_NumericVector();
  qs::c_qsave(reference,"/home/akhila/fuzzer_packages/fuzzedpackages/sirus/inst/testfiles/numSmaller/inputs/reference.qs",
		"high", "zstd", 1, 15, true, 1);
