...
# acceleration.
gmmRst = GMKMcharlie::GM(X, G = 3L, maxCore = 2L)
str(gmmRst)
...
gmmFit = GMKMcharlie::GM(X, Xw = Xw, G = 5L, maxCore = 2L, verbose = FALSE)
...
d = 3L
G = 10L
gmmFit = GMKMcharlie::GM(X, G = G, maxCore = 2L, verbose = FALSE)
