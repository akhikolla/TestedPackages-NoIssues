...
TEST(earthtide_deepstate_test,legendre_test){
  ...
  std::string l_max_t = "/home/akhila/fuzzer_packages/fuzzedpackages/earthtide/inst/testfiles/legendre/AFL_legendre/afl_inputs/" + std::to_string(t) + "_l_max.qs";
  qs::c_qsave(l_max,l_max_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "l_max values: "<< l_max << std::endl;
  NumericVector x(1);
  x[0]  = RcppDeepState_double();
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/earthtide/inst/testfiles/legendre/AFL_legendre/afl_inputs/" + std::to_string(t) + "_x.qs";
  qs::c_qsave(x,x_t,
		"high", "zstd", 1, 15, true, 1);
