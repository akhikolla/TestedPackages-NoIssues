...
TEST(REddyProc_deepstate_test,whichValueGreaterEqualC_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/REddyProc/inst/testfiles/whichValueGreaterEqualC/AFL_whichValueGreaterEqualC/afl_inputs/" + std::to_string(t) + "_x.qs";
  qs::c_qsave(x,x_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x values: "<< x << std::endl;
  IntegerVector threshold  = RcppDeepState_IntegerVector();
  std::string threshold_t = "/home/akhila/fuzzer_packages/fuzzedpackages/REddyProc/inst/testfiles/whichValueGreaterEqualC/AFL_whichValueGreaterEqualC/afl_inputs/" + std::to_string(t) + "_threshold.qs";
  ...
  std::string iStart_t = "/home/akhila/fuzzer_packages/fuzzedpackages/REddyProc/inst/testfiles/whichValueGreaterEqualC/AFL_whichValueGreaterEqualC/afl_inputs/" + std::to_string(t) + "_iStart.qs";
