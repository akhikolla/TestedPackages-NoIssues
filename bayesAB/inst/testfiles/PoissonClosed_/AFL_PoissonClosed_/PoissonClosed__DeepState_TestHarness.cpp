...
TEST(bayesAB_deepstate_test,PoissonClosed__test){
  ...
  std::string alpha_1_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bayesAB/inst/testfiles/PoissonClosed_/AFL_PoissonClosed_/afl_inputs/" + std::to_string(t) + "_alpha_1.qs";
  ...
  std::string beta_1_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bayesAB/inst/testfiles/PoissonClosed_/AFL_PoissonClosed_/afl_inputs/" + std::to_string(t) + "_beta_1.qs";
  qs::c_qsave(beta_1,beta_1_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "beta_1 values: "<< beta_1 << std::endl;
  NumericVector alpha_2(1);
  alpha_2[0]  = RcppDeepState_double();
  std::string alpha_2_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bayesAB/inst/testfiles/PoissonClosed_/AFL_PoissonClosed_/afl_inputs/" + std::to_string(t) + "_alpha_2.qs";
  qs::c_qsave(alpha_2,alpha_2_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "alpha_2 values: "<< alpha_2 << std::endl;
  NumericVector beta_2(1);
  beta_2[0]  = RcppDeepState_double();
  std::string beta_2_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bayesAB/inst/testfiles/PoissonClosed_/AFL_PoissonClosed_/afl_inputs/" + std::to_string(t) + "_beta_2.qs";
