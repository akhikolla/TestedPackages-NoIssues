...
TEST(ztpln_deepstate_test,do_rpln_test){
  ...
  qs::c_qsave(mu,"/home/akhila/fuzzer_packages/fuzzedpackages/ztpln/inst/testfiles/do_rpln/inputs/mu.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mu values: "<< mu << std::endl;
  NumericVector sig(1);
  sig[0]  = RcppDeepState_double();
  qs::c_qsave(sig,"/home/akhila/fuzzer_packages/fuzzedpackages/ztpln/inst/testfiles/do_rpln/inputs/sig.qs",
		"high", "zstd", 1, 15, true, 1);
