...
TEST(ROI.plugin.qpoases_deepstate_test,sqproblem_test){
  ...
  std::string number_of_varibales_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ROI.plugin.qpoases/inst/testfiles/sqproblem/libFuzzer_sqproblem/libfuzzer_inputs/" + std::to_string(current_timestamp) +
  ...
  std::string number_of_constraints_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ROI.plugin.qpoases/inst/testfiles/sqproblem/libFuzzer_sqproblem/libfuzzer_inputs/" + std::to_string(current_timestamp) +
  ...
  std::string hessian_type_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ROI.plugin.qpoases/inst/testfiles/sqproblem/libFuzzer_sqproblem/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_hessian_type.qs";
  ...
  std::string alloc_dense_matrix_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ROI.plugin.qpoases/inst/testfiles/sqproblem/libFuzzer_sqproblem/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_alloc_dense_matrix.qs";
