...
TEST(ROI.plugin.qpoases_deepstate_test,qproblemb_test){
  ...
  qs::c_qsave(number_of_varibales,"/home/akhila/fuzzer_packages/fuzzedpackages/ROI.plugin.qpoases/inst/testfiles/qproblemb/inputs/number_of_varibales.qs",
  ...
  qs::c_qsave(hessian_type,"/home/akhila/fuzzer_packages/fuzzedpackages/ROI.plugin.qpoases/inst/testfiles/qproblemb/inputs/hessian_type.qs",
		"high", "zstd", 1, 15, true, 1);
  ...
  qs::c_qsave(alloc_dense_matrix,"/home/akhila/fuzzer_packages/fuzzedpackages/ROI.plugin.qpoases/inst/testfiles/qproblemb/inputs/alloc_dense_matrix.qs",
		"high", "zstd", 1, 15, true, 1);
