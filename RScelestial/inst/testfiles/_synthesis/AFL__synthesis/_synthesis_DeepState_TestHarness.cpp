...
TEST(RScelestial_deepstate_test,_synthesis_test){
  ...
  std::string sample_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_sample.qs";
  qs::c_qsave(sample,sample_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "sample values: "<< sample << std::endl;
  IntegerVector site(1);
  site[0]  = RcppDeepState_int();
  std::string site_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_site.qs";
  qs::c_qsave(site,site_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "site values: "<< site << std::endl;
  IntegerVector evolutionSteps(1);
  evolutionSteps[0]  = RcppDeepState_int();
  std::string evolutionSteps_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_evolutionSteps.qs";
  ...
  std::string mutationRate_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_mutationRate.qs";
  ...
  std::string advantageIncreaseRatio_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_advantageIncreaseRatio.qs";
  ...
  std::string advantageDecreaseRatio_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_advantageDecreaseRatio.qs";
  ...
  std::string advantageKeepRatio_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_advantageKeepRatio.qs";
  ...
  std::string advantageIncreaseStep_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_advantageIncreaseStep.qs";
  ...
  std::string advantageDecreaseStep_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_advantageDecreaseStep.qs";
  ...
  std::string mvRate_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_mvRate.qs";
  qs::c_qsave(mvRate,mvRate_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mvRate values: "<< mvRate << std::endl;
  NumericVector fpRate(1);
  fpRate[0]  = RcppDeepState_double();
  std::string fpRate_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_fpRate.qs";
  qs::c_qsave(fpRate,fpRate_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "fpRate values: "<< fpRate << std::endl;
  NumericVector fnRate(1);
  fnRate[0]  = RcppDeepState_double();
  std::string fnRate_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_fnRate.qs";
  qs::c_qsave(fnRate,fnRate_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "fnRate values: "<< fnRate << std::endl;
  IntegerVector seed(1);
  seed[0]  = RcppDeepState_int();
  std::string seed_t = "/home/akhila/fuzzer_packages/fuzzedpackages/RScelestial/inst/testfiles/_synthesis/AFL__synthesis/afl_inputs/" + std::to_string(t) + "_seed.qs";
